                    ...
                    <div class="page-component-header-fixed">
                            ...
                            <div class="menu-wrapper">
                                ...
                                <ul class="main-menu pull-right">
                                    ...
                                    <li class="mobile_user_photo">
                                        <a href="{{ url("#") }}" class="username-main-selector" type="button"
                                ...
                                <div class="page-menu-wrapper">
                                    ...
                                    <ul class="page-menu page-menu-6" id="nav-tab" role="tablist">
                                        ...
                                        <li class="wrapper">
                                            <a id="reporting-tab-button" class="link traffic-tracking active"
                        ...
                        <div class="submenu-items">
                            <div class="tools-menu-container">
                                ...
                                <ul class="items items-2 report_page_tab_nemu">
                                    <li class="item report_tab_nemu active">
                                        <div class="item-click">
                                            <a id="reporting-menu" class="traffic-tracking" href="{{ url("#") }}">
                                                <div class="text">
                                                    Reporting
                                                </div>
                                            </a>
                                    ...
                                    <li class="item invoice_tab_nemu">
                                        <div class="item-click">
                                            <a id="invoice-menu" class="traffic-tracking" href="{{ url("#") }}">
                                                <div class="text">
                                                    Invoice
                                                </div>
                                            </a>
