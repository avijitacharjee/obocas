                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="a5c3ef8268">
                                                        ...
                                                        <a href="{{ url("#") }}" target="_blank">
                                                            <img src="{{asset('/storage')}}/{{explode(';',$property->property_images)[0]}}"
                                                                    ...
                                                                    <div class="_29c344764">
                                                                        <div class="_cff98816f">
                                                                            <a target="_blank" href="{{ url("#") }}"
                                                                                ...
                                                                                <span>
                                                                                    <span
                                                                                        class="af1ddfc958 eba89149fb">{{$property->city}}</span>
                                                                                    <span
                                                                                ...
                                                                                <div class="_29c344764">
                                                                                    <div>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                class="fde444d7ef _e885fdc12">BDT&nbsp;{{$property->cot_price}}</span>
                                                                                        </div>
                                                                                        <div
