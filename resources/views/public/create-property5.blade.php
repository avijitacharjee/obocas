                        ...
                        <div class="row">
                            ...
                            <div class="">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="seg-return-to-overview hidden">
                                        <a href="{{ url('#') }}">
                                            Go back to overview
                                        </a>
                                    </div>
                            ...
                            <div class="main-content col-md-12">
                                <div class="row">
                                    <div id="main_content_section" class="col-md-9">
                                        <table id="room_summaries"
                                            class="rooms-table roomlist-container seg-rooms-table"
                                            style="display: table;">
                                            <tbody>
                                                <tr id="room_summary_857487235" class="room-item roomlist-items">
                                                    <td>
                                                        <i class="pull-right occupancy-icon occupancy_max4"
                                                            title="4 adults"></i>
                                                        <h4>Deluxe Room</h4>
                                                    </td>
                                                    <td>
                                            ...
                                            <fieldset id="main-room-form" class="active">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm-6 col-xs-12">
                                                        ...
                                                        <select id="no_smoking" name="no_smoking" class="form-control">
                                                            ...
                                                            <option value="2">I have both smoking and non-smoking
                                                                options for this room type</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm-6 col-xs-12" id="nr_rooms_wrapper">
                                                        ...
                                                        <input class="form-control" name="num_rooms" id="num_rooms"
                                                            style="width: 60px;">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div id="alternative_1">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-12 guests-occupancy">
                                                                <input type="tel" id="num_guests" name="num_guests"
                                                ...
                                                <div class="row">
                                                    <div class="room_size_wrapper col-sm-6 col-md-6">
                                                        <div
                                                            ...
                                                            <select name="room_measunit" class="form-control">
