		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ url('index.html') }}" class="logo">
					<img src="{{ asset('/admin/assets/img/logo-white.png') }}" alt="Logo">
				</a>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<a href="{{ url('mentor.html') }}"><i class="feather-home"></i><span>Hotel List</span></a>
						</li>
						<li>
												...
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																...
																alt="User Image"></a>
														<a href="{{ url('profile.html') }}">James Amen</a>
													</h2>
												</td>
												<td>Maths</td>
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/user/user.jpg') }}" alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Jonathan Doe </a>
													</h2>
												</td>
											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/profiles/avatar-07.jpg') }}"
																alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Jessica Fogarty</a>
													</h2>
												</td>
												...
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/user/user1.jpg') }}" alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Julie Pennington </a>
													</h2>
												</td>
												...
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																...
																alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Jose Anderson</a>
													</h2>
												</td>
												<td>Algebra</td>
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/user/user2.jpg') }}" alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Tyrone Roberts</a>
													</h2>
												</td>
											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																...
																alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Sofia Brient</a>
													</h2>
												</td>
												...
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/user/user3.jpg') }}" alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Allen Davis </a>
													</h2>
												</td>
												...
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																...
																alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Marvin Campbell</a>
													</h2>
												</td>
												<td>Flow chart</td>
												<td>
													<h2 class="table-avatar">
														<a href="{{ url('profile.html') }}" class="avatar avatar-sm mr-2"><img
																class="avatar-img rounded-circle"
																src="{{ asset('/admin/assets/img/user/user4.jpg') }}" alt="User Image"></a>
														<a href="{{ url('profile.html') }}">Patricia Manzi </a>
													</h2>
												</td>
