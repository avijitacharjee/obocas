                    ...
                    <main id="content" class="main">
                        <div class="js-dont-warn-about-unsaved-changes bui-container bui-container--center">
                            ...
                            <div id="rcatContainer" class="rp--mobile-friendly">
                                ...
                                <div class="bui-grid">
                                    <div
                                        class="bui-grid__column-full bui-grid__column-10@medium bui-grid__column-8@large">
                                        <form id="flexible_rate_form">

                                            <h1>Add fully flexible rate plan</h1>

                                            <div id="flexible_create"
                                                class="bui-container rp-container--no-pading@small">
                                                <div
                                                    class="form-container form-create pad-lg-left pad-lg-right pad-lg-top">




                                                    <div id="create_ratePolicyField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">

                                                            <span class="form-heading">
                                                                Which cancellation policy would you like to use for this
                                                                rate plan?
                                                            </span>
                                                            ...
                                                            <div class="bui-radio">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" type="radio"
                                                                            id="create_ratePolicy__-3"
                                                                            name="rate-policy" value="-3"
                                                                            checked=""><span class="bui-radio__label"
                                                                            data-ref="label">Flexible - 1
                                                                            day</span></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" type="radio"
                                                                            id="create_ratePolicy__-4"
                                                                            name="rate-policy" value="-4"><span
                                                                            class="bui-radio__label"
                                                                            data-ref="label">Flexible - 2
                                                                            days</span></label>
                                                            ...
                                                            <div class="recommendation-container">
                                                                <div class="form-validation neutral-message">
                                                                    ...
                                                                    <span>
                                                                        Fully flexible rates are generally the most
                                                                        expensive rates on Booking.com. Guests are often
                                                                        willing to pay extra for the freedom to cancel
                                                                        free of charge and get a full refund.
                                                                    </span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="create_rateMealOptionsField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">
                                                            <span class="form-heading">Would you like to include meals
                                                                in this rate plan?</span>
                                                            <div class="bui-radio">
                                                                <div class="form-group">

                                                                    <label class="bui-radio add-meal-plan-button-close">
                                                                        <input class="bui-radio__input" data-ref="input"
                                                                            type="radio" id="create_rateMealOptionNo"
                                                                            name="rate-meal-option" value="no"
                                                                            checked=""
                                                                            data-on-click="updateRCMealOption(event)"><span
                                                                            class="bui-radio__label"
                                                                            data-ref="label">No</span></label>

                                                                </div>
                                                                <div class="form-group">

                                                                    <label class="bui-radio add-meal-plan-button">
                                                                        <input class="bui-radio__input" data-ref="input"
                                                                            type="radio" id="create_rateMealOptionYes"
                                                                            name="rate-meal-option" value="yes"
                                                                            data-on-click="updateRCMealOption(event)"><span
                                                                            class="bui-radio__label"
                                                                            data-ref="label">Yes, add a meal
                                                                            plan</span>
                                                                    </label>
                                                            ...
                                                            <div class="checkbox-list d-none add-meal-plan">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="bui-form__group "><label
                                                                            class="bui-checkbox"><input
                                                                                ...
                                                                                data-ref="input" type="checkbox"
                                                                                id="create_mealPlan_meals_breakfast"
                                                                                value="meals_breakfast"
                                                                                data-on-click="updateRCMealPlan(event)"><span
                                                                                class="bui-checkbox__label"
                                                                                data-ref="label">Breakfast</span></label>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="bui-form__group "><label
                                                                            class="bui-checkbox"><input
                                                                                class="bui-checkbox__input "
                                                                                data-ref="input" type="checkbox"
                                                                                id="create_mealPlan_meals_lunch"
                                                                                value="meals_lunch"
                                                                                data-on-click="updateRCMealPlan(event)"><span
                                                                                class="bui-checkbox__label"
                                                                                data-ref="label">Lunch</span></label>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="bui-form__group "><label
                                                                            class="bui-checkbox"><input
                                                                                class="bui-checkbox__input "
                                                                                data-ref="input" type="checkbox"
                                                                                id="create_mealPlan_meals_dinner"
                                                                                value="meals_dinner"
                                                                                data-on-click="updateRCMealPlan(event)"><span
                                                                                class="bui-checkbox__label"
                                                                                data-ref="label">Dinner</span></label>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="bui-form__group "><label
                                                                            class="bui-checkbox"><input
                                                                                class="bui-checkbox__input "
                                                                                data-ref="input" type="checkbox"
                                                                                id="create_mealPlan_meals_all_inclusive"
                                                                                value="meals_all_inclusive"
                                                                                data-on-click="updateRCMealPlan(event)"><span
                                                                                class="bui-checkbox__label"
                                                                                data-ref="label">All
                                                                                inclusive</span></label></div>
                                                                ...
                                                                <div class="recommendation-container">
                                                                    <div class="form-validation warning-message">
                                                                        ...
                                                                        <span>
                                                                            54% of bookings are made without meals. You
                                                                            can always offer meals to guests upon
                                                                            arrival.
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div id="create_rateMinLOSField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">
                                                            <span class="form-heading">Would you like to set a minimum
                                                                length of stay for this rate plan?</span>
                                                            <div class="bui-radio">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" type="radio"
                                                                            name="rate-min-los" value="no"
                                                                            checked=""><span class="bui-radio__label"
                                                                            data-ref="label">No
                                                                            (this rate plan is available for any length
                                                                            of stay)</span></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" type="radio"
                                                                            id="create_rateMinLOSYes"
                                                                            name="rate-min-los" value="yes"><span
                                                                            class="bui-radio__label">Yes</span></label>
                                                            ...
                                                            <div>
                                                                <div class="form-group">
                                                                    <input type="number" min="2" max="28"
                                                                        id="create_rateMinLOSNights"
                                                                        name="rate-min-los-nights" value="2"
                                                                        data-on-change="updateRCMinLOSNights(event)">
                                                                ...
                                                                <div class="recommendation-container">
                                                                    <div class="form-validation warning-message">
                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            48% of bookings are made for only one night.
                                                                            If you set a minimum length of stay, you are
                                                    ...
                                                    <div id="create_rateManageField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">
                                                            <span class="form-heading">How would you like to manage this
                                                                rate plan?</span>
                                                            <div class="bui-radio">
                                                                <div class="form-group">
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" data-ref="input"
                                                                            type="radio" id="create_rateManageNew"
                                                                            name="rate-manage" value="new"
                                                                            data-on-click="updateRCManageRateOption(event)"><span
                                                                            class="bui-radio__label"
                                                                            data-ref="label">Set up as a new rate plan
                                                                        </span></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="bui-radio "><input
                                                                            class="bui-radio__input" type="radio"
                                                                            name="rate-manage" checked=""><span
                                                                            class="bui-radio__label"
                                                                            data-ref="label">Based on one of my current
                                                                            rate plans</span></label>

                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <select id="create_rateManageExistingRates">
                                                                    <option value="Standard Rate" selected="">
                                                                        Standard Rate
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="recommendation-container">
                                                                <div class="form-validation neutral-message">
                                                                    <span>
                                                                        This is the easiest and quickest way to manage
                                                                        your new rate plan. It will base its price on
                                                                        Standard Rate, plus whatever price increase you
                                                                        set in the next step. The rate plan will only be
                                                                        available on Booking.com. You won't need to
                                                                        change prices, load availability or map the rate
                                                                        plan in your channel manager.
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="create_rateDiscountField"
                                                        class="form-question form-question-fadein">
                                                        <div class="form-question-container pad-lg-bottom">

                                                            <span class="form-heading">
                                                                How much more expensive than Standard Rate would you
                                                                like to set this rate plan?
                                                            </span>
                                                                    ...
                                                                    <div class="form-bleed-top-bottom">
                                                                        <div class="bui-form__group">
                                                                            <input type="number" min="0"
                                                                                id="create_rateDiscount"
                                                                                name="rate-discount" class=""
                                                                                value="10">
                                                                            <select id="create_ratePriceSettingUnit">
                                                    ...
                                                    <div id="create_rateRoomsField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">
                                                            <span class="form-heading">Which room types will be bookable
                                                                with this rate plan?</span>

                                                            <div class="form-group">

                                                                <div class="bui-form__group "><label
                                                                        class="bui-checkbox"><input
                                                                            class="bui-checkbox__input " type="checkbox"
                                                                            checked=""><span class="bui-checkbox__label"
                                                                            data-ref="label">Deluxe Double
                                                                            Room</span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <div id="create_rateNameField" class="form-question">
                                                        <div class="form-question-container pad-lg-bottom">
                                                            <span class="form-heading">What would you like to name this
                                                                rate plan?</span>
                                                            <div>
                                                                <input type="text" class="bui-form__control"
                                                                    name="rate-name">
                                                                <div class="recommendation-container">
                                                                    <div class="form-validation neutral-message">

                                                                        <span>
                                                                            This name is just for you. We won't show it
                                                                            to customers on Booking.com.
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div id="create_rateCTAField" class="form-question">
                                                            <div class="form-question-container-last">
                                                                <a href="{{ url("review-edit-reat-plan.html") }}"
                                                                    class="bui-button bui-button--primary bui-button--wide "><span
                                                                        class="bui-button__text">Review</span></a>
                                                            </div>
                                                        </div>
                                                    </div>
