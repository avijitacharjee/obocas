									...
									<div class="ext-action-menu__item">
										...
										<div class="ext-action-dropdown__menu dropdown-menu dropdown-menu-end">
											<div>
														...
														<a href="{{ url("#") }}" class="ext-action-dropdown__item">
															<span>
																<svg width="20" height="20" fill="currentColor"
																	viewBox="0 0 24 24" role="presentation"
																	aria-hidden="true" focusable="false"
																	class="ext-action-dropdown__icon bk-icon -streamline-account_create"
																	slot="icon">
																	<path
														...
														<a href="{{ url("#") }}" class="ext-action-dropdown__item">
															<span>
																<svg width="20" height="20" fill="currentColor"
																	viewBox="0 0 24 24" role="presentation"
																	aria-hidden="true" focusable="false"
																	class="ext-action-dropdown__icon bk-icon -streamline-mobile_phone"
																	slot="icon">
																	<path
														...
														<a href="{{ url("#") }}" class="ext-action-dropdown__item">
															<span>
																<svg width="20" height="20" fill="currentColor"
																	viewBox="0 0 24 24" role="presentation"
																	aria-hidden="true" focusable="false"
																	class="ext-action-dropdown__icon bk-icon -streamline-note_edit"
																	slot="icon">
																	<path
																		d="M22.1 14.332l-7.63 7.63.383-.205-3.75.75.882.882.75-3.75-.205.383 7.63-7.63a1.366 1.366 0 0 1 1.932 0l-.023-.023c.564.565.565 1.428.033 1.96l-.002.002zm1.06 1.06l.004-.003a2.863 2.863 0 0 0-.004-4.049l.023.024c-1.15-1.151-2.964-1.151-4.083-.032l-7.63 7.63a.75.75 0 0 0-.205.383l-.75 3.75a.75.75 0 0 0 .882.882l3.75-.75a.75.75 0 0 0 .383-.205l7.63-7.63zm-14.91 4.1h-6a.719.719 0 0 1-.75-.696V3.85a.813.813 0 0 1 .777-.857H17.25c.417.016.765.388.75.832v4.418a.75.75 0 0 0 1.5 0V3.849c.041-1.246-.953-2.31-2.223-2.357H2.25A2.312 2.312 0 0 0 0 3.874v14.96a2.214 2.214 0 0 0 2.269 2.158H8.25a.75.75 0 0 0 0-1.5zM4.5.742v4.5a.75.75 0 0 0 1.5 0v-4.5a.75.75 0 0 0-1.5 0zm4.5 0v4.5a.75.75 0 0 0 1.5 0v-4.5a.75.75 0 0 0-1.5 0zm4.5 0v4.5a.75.75 0 0 0 1.5 0v-4.5a.75.75 0 0 0-1.5 0z">
																	</path>
																</svg>
																Contracts
															</span>
												...
												<h4 class="ext-action-dropdown__paragraph">
													<span>Add properties to your account</span>
												</h4>
												<ul class="ext-action-dropdown__content">
													<li>
														<a href="{{ url("#") }}" data-test-id="add-existing-property"
															class="ext-action-dropdown__item">
															<svg width="20" height="20" fill="currentColor"
																viewBox="0 0 24 24" role="presentation"
																aria-hidden="true" focusable="false"
																class="ext-action-dropdown__icon bk-icon -streamline-plus_circle"
																slot="icon">
																<path
															...
															<span>Add existing properties</span>
														</a>
													</li>
												</ul>
											</div>
