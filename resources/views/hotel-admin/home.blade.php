                        ...
                        <div class="bui-grid__column-full bui-grid__column-10@large">
                            ...
                            <div class="homepage-main-tabs-container bui-spacer--large">
                                <div class="customize-controls">
                                    <svg role="presentation" focusable="false" width="16" aria-hidden="true"
                                        height="16" fill="#6B6B6B" viewBox="0 0 24 24"
                                        class="bui-u-hidden@huge bk-icon -streamline-bell_normal" color="#6B6B6B">
                                        <path
                                ...
                                <div class="bui-tab">
                                    ...
                                    <ul class="bui-tab__nav nav  nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li role="presentation"
                                            ...
                                            <button class="bui-tab__link" id="home-tab" data-bs-toggle="tab"
                                                data-bs-target="#home" role="tab" aria-controls="home"
                                                aria-selected="true">
                                                <div class="bui-group bui-group--inline">
                                                    <svg aria-hidden="true" width="20" focusable="false"
                                                        role="presentation" fill="#6B6B6B" viewBox="0 0 24 24"
                                                        height="20"
                                        ...
                                        <li role="presentation"
                                            ...
                                            <button class="bui-tab__link" id="profile-tab" data-bs-toggle="tab"
                                                data-bs-target="#profile" role="tab" aria-controls="profile"
                                                aria-selected="false">
                                                <div class="bui-group bui-group--inline">
                                                    <svg focusable="false" role="presentation" aria-hidden="true"
                                                        width="20" fill="#6B6B6B" viewBox="0 0 24 24" height="20"
                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <div class="homepage-operations-tab">
                                                <div class="bui-group bui-group--large">
                                                    <div>
                                                        ...
                                                        <div class="homepage-blocks-wrapper">
                                                            <div class="homepage-blocks-wrapper__content">
                                                                <header class="homepage-blocks-wrapper__header">
                                                                    <div
                                                    ...
                                                    <div class="homepage-selectable-card-wrapper homepage-blocks-wrapper">
                                                        <div class="homepage-blocks-wrapper__content">
                                                            ...
                                                            <div class="homepage-blocks-wrapper__content">
                                                                ...
                                                                <div class="homepage-card-header">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="bui-grid__column-full bui-grid__column-9@medium">
                                                                            <span class="bui-f-font-display_one"><span>Unanswered
                                                                                    messages</span></span>
                                                                        </div>
                                                                        <div
                                                                            class="homepage-header__text-right bui-grid__column-full bui-grid__column-3@medium">
                                                            ...
                                                            <div class="homepage-blocks-wrapper__content">
                                                                ...
                                                                <div class="homepage-card-header">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="bui-grid__column-full bui-grid__column-9@medium">
                                                                            <span class="bui-f-font-display_one"><span>Recent
                                                                                    reviews</span></span>
                                                                        </div>
                                                                        <div
                                                                            class="homepage-header__text-right bui-grid__column-full bui-grid__column-3@medium">
                                                ...
                                                <div class="bui-group bui-group--large">
                                                                        ...
                                                                        <div>
                                                                            <div class="bui-grid">
                                                                                <div
                                                                                    ...
                                                                                    <div class="homepage-demand-data">
                                                                                        <div class="bui-spacer--larger">
                                                                                            <div
                                                                ...
                                                                <div class="homepage-scores-table">
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="bui-grid__column-full bui-grid__column-9@medium">
                                                                                <span class="bui-f-font-display_one"><span>Your
                                                                                        scores</span></span>
                                                                            </div>
                                                                            <div
                                                                                class="homepage-header__text-right bui-grid__column-full bui-grid__column-3@medium">
                                                    ...
                                                    <div>
                                                        <div class="homepage-blocks-wrapper">
                                                            <div class="homepage-blocks-wrapper__content">
                                                                <!---->
                                                                <div class="homepage-booking-performance">
                                                                    <div>
                                                                        <div
                                                                            class="bui-grid bui-grid--align-center bui-grid--bleed">
                                                                            <div
                                                                    ...
                                                                    <div class="homepage-booking-performance__grid">
                                                                        <div class="bui-grid bui-grid--bleed">
                                                                            <div
                                                    ...
                                                    <div>
                                                        <div class="homepage-blocks-wrapper">
                                                            <div class="homepage-blocks-wrapper__content">
                                                                <!---->
                                                                <div class="homepage-search-performance">
                                                                    <div>
                                                                        <div
                                                                            class="bui-grid bui-grid--align-center bui-grid--bleed">
                                                                            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="">
                            <div>
                                <h3 class="sidebar-title-with-icon">
                                    <svg width="16" aria-hidden="true" role="presentation" focusable="false"
                                        height="16" fill="#6B6B6B" viewBox="0 0 24 24"
                        ...
                        <div>
                            <div class="bui-spacer--large">
                                <h3 class="sidebar-title-with-icon">
                                    <svg fill="#6B6B6B" viewBox="0 0 24 24" height="16" aria-hidden="true"
                                        width="16" focusable="false" role="presentation"
                                        class="bk-icon -streamline-lightbulb">
                                        <path
