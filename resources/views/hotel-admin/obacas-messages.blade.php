				...
				<div class="js-dont-warn-about-unsaved-changes">
					...
					<main class="main">
						<div class="bui-container bui-container--center">
							<div class="bui-page-header bui-spacer--large">
							...
							<div class="bui-grid">
								<div class="bui-grid__column-full bui-grid__column-8@medium">
									<div class="bui-tab">
										<ul role="tablist" class="bui-tab__nav nav  nav-tabs" id="myTab" role="tablist">
											<li role="tab" class="bui-tab__item" role="presentation">
												<button	data-bs-toggle="tab" data-bs-target="#allmessage" role="tab" aria-controls="home" aria-selected="true" class="bui-tab__link active">
													<span>All
														messages</span>
											...
											<li role="tab" class="bui-tab__item" role="presentation">
												<button data-bs-toggle="tab" data-bs-target="#Starred" role="tab" aria-controls="Starred" aria-selected="true"
													class="bui-tab__link"><span>Starred</span>
													</button>
												</li>
											<li role="tab" class="bui-tab__item" role="presentation">
												<button data-bs-toggle="tab" data-bs-target="#Sent" role="tab" aria-controls="Sent" aria-selected="true"
													class="bui-tab__link"><span>Sent</span>
													</button>
												</li>
											
										</ul>

										<div  class="tab-content" idd="myTabContent">

											<div class="inbox-threads bui-spacer--medium tab-pane fade show active" id="allmessage" role="tabpanel">
													<!-- Data Table-->
											...
											<div class="inbox-threads bui-spacer--medium tab-pane fade" id="Starred" role="tabpanel">
													<!-- Data Table-->
													<div class="table-responsive mt-5">
														<table class="table align-middle">
															<!-- Table Head -->
											...
											<div class="inbox-threads bui-spacer--medium tab-pane fade" id="Sent" role="tabpanel">
													<!-- Data Table-->
													<div class="table-responsive mt-5">
														<table class="table align-middle">
															<!-- Table Head -->
								...
								<div class="bui-grid__column-full bui-grid__column-4@medium">
									<div class="bui-spacer--larger bui-card">
										<div class="bui-card__content">
											<header class="bui-card__header">
												<h1 class="bui-card__title"><span>Get instant help</span></h1>
											</header>
											<p class="bui-card__text"><span>Find answers to your questions
													quickly</span></p>
											<div placeholder="Type your question"
												class="bui-spacer--large bui-form__group"><label
													for="inbox-search-help-center"></label> <input
													id="inbox-search-help-center"
													aria-describedby="describe-inbox-search-help-center"
													autocomplete="off" type="text" placeholder="Type your question"
													value="" class="bui-form__control">
												
											</div>
											<div class="bui-spacer--large bui-f-font-strong"><span>Popular topics</span>
											</div>
											<ul class="bui-list bui-list--unordered">
												<li class="bui-list__item"><a
														href="{{ url("#") }}"
													>
														Your reservations
													</a></li>
												...
												class="bui-spacer--large bui-button bui-button--secondary">
												 <span class="bui-button__text"><span>See more
														topics</span></span></button>
											<hr class="bui-spacer--large bui-divider">
											<div class="bui-spacer--large bui-f-font-strong"><span>Can't find what you
													need?</span></div> <button type="button"
												class="bui-button bui-button--secondary">
												 <span class="bui-button__text"><span>See contact
