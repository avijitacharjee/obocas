					...
					<main class="main">
						<div class="bui-container bui-container--center">
							<div role="navigation" class="bui-breadcrumb bui-breadcrumb--back">
								<div class="bui-breadcrumb__item">
									<svg role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
										width="16" height="16" class="bui-breadcrumb__icon">
										<path
									...
									<div class="bui-breadcrumb__text">
										<a href="{{ url("#") }}" class="bui-link bui-link--secondary">
											<span>Go back to Policies</span>
										</a>
									</div>
								</div>
							</div>
							<div class="bui-page-header">
								...
								<h1 class="bui-page-header__title">
									<span>Date changes for non-refundable bookings</span>
								</h1>
								<div class="bui-page-header__actions">
									<div class="ext-feedback-cta">
										<div class="ext-feedback-thumbs">
											<span possible-tags="ext_footer_feedback_share_feedback_cta">Do you find
												this
												page helpful?</span>
											<button class="ext-feedback__rating">
												<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" width="16"
													fill="currentColor" role="presentation" height="16"
							...
							<div class="bui-spacer--large">
								<div class="bui-grid">
									<div class="bui-grid__column-full bui-grid__column-8@medium">
										<div class="bui-panel">
											<div class="modification-prefs-options bui-spacer--large">
												<div class="bui-spacer">
													<h2 class="modification-prefs-header">
														<span>Automate your process
															for date changes?</span></h2> <span>Your revenue is
														guaranteed as guests <strong>can only reschedule once</strong>,
														for the <strong>same or higher price</strong>, and for the
														<strong>same booking conditions and room type</strong>. Date
														changes are based on your real-time availability, prices and
														restrictions.</span>
												</div>
												<div role="group" class="bui-group bui-group--large">
													<div name="is_opt_in" class="bui-form__group">
														<label class="bui-checkbox">
															<input autocomplete="off" type="checkbox" name="is_opt_in"
																class="bui-checkbox__input"> <span
																class="bui-checkbox__label">
																<p><span>Allow guests to change dates</span></p>
															</span>
														</label>

													</div>
													<div role="group"
														class="modification-prefs-days-count bui-group bui-group--large">
														<div name="minDays" disabled="disabled" class="bui-form__group">
															<label class="bui-radio">
																<input id="min-day-0" autocomplete="off" type="radio"
																	name="minDays" checked="checked" value="3"
																	class="bui-radio__input">
																<span class="bui-radio__label">
																	<span>3 days or more before
																		check-in</span>
																	<div role="status"
																		class="bui-alert bui-alert--inline bui-alert--success">
																		<span role="presentation"
																			class="icon--hint bui-alert__icon">
																		...
																		<div class="bui-alert__description">
																			...
																			<p class="bui-alert__text">
																				<span>Good
																					choice! You will save a lot of time
																					managing change requests as most
																					non-refundable rates are booked just
																					before check-in.</span>
																			</p>
														...
														<div name="minDays" disabled="disabled" class="bui-form__group">
															<label class="bui-radio">
																<input id="min-day-1"
																	autocomplete="off" type="radio" name="minDays"
																	value="5" class="bui-radio__input"> <span
																	class="bui-radio__label"><span>5 days or more before
																		check-in</span>
																</span></label>

														</div>
														<div name="minDays" disabled="disabled" class="bui-form__group">
															<label class="bui-radio"><input id="min-day-2"
																	autocomplete="off" type="radio" name="minDays"
																	value="7" class="bui-radio__input"> <span
																	class="bui-radio__label"><span>7 days or more before
																		check-in</span>
																</span>
															</label>
													...
													<div name="is_date_exception" disabled="disabled"
														class="bui-form__group"><label class="bui-checkbox"><input
																autocomplete="off" type="checkbox"
																name="is_date_exception" class="bui-checkbox__input">
															<span class="bui-checkbox__label">
																<p><span>Add exceptions to date changes</span></p>
															</span></label>

													</div>
												</div>
												<div class="modification-prefs-info bui-f-font-caption">
													<p><span>You can selectively disable date change for non-refundable
															bookings, for up to 30 check-in dates per year.</span></p>
													<p>

													</p>
												</div>
												<div class="modification-prefs-exceptions">
													<h6><span>Choose your dates</span></h6>
													<div class="bui-spacer--small">
														<hr class="bui-divider">
													</div>
													<div class="bui-spacer">
														<div role="group" class="bui-group"><span>You haven't added
																exceptions to any dates this year. </span> <span
																class="modification-prefs-exceptions__days-left"><span>You
																	have <strong>30 dates</strong> left.</span></span>
														</div>
													</div>
																		...
																		<div class="bui-spacer--medium">
																			<div class="ext-datepicker__wrap">
																				<div class="ext-datepicker__text-input bui-form__group">
																					...
																					<input id="date-from" type="date" value="2022-03-19" class="bui-form__control">
																		...
																		<div class="bui-spacer--medium">
																			<div class="ext-datepicker__wrap">
																				<div class="ext-datepicker__text-input bui-form__group">
																					...
																					<input id="date-until" type="date" value="2022-04-18" class="bui-form__control">
																				</div>
																			</div>
																		</div>
																	</div>
									...
									<div class="bui-grid__column-full bui-grid__column-4@medium">
										<div role="group" class="modification-prefs-usps bui-group bui-group--large">
											<div class="bui-banner bui-u-bleed@small bui-banner--hint"><span
													class="bui-banner__icon"><svg aria-hidden="true" focusable="false"
														role="presentation" height="24" width="24" viewBox="0 0 24 24"
														fill="currentColor" class="bk-icon -streamline-info_sign">
														<path
												...
												<div class="bui-banner__content">
													<h1 class="bui-banner__title"><span>Save time and improve your guest
															experience</span></h1>
													<p class="bui-banner__text"><span>Reduce your operational workload
															and help guests keep their bookings by making it easier for
															them to reschedule if there's a change in
											...
											<div class="bui-banner bui-u-bleed@small bui-banner--hint"><span
												...
												<div class="bui-banner__content">
													<h1 class="bui-banner__title"><span>You decide when guests can make
															changes</span></h1>
													<p class="bui-banner__text"><span>Customise this feature to suit
															your needs by choosing a deadline for date changes or adding
															exceptions based on your preferences.</span></p>
												</div> 
							...
							<div>
								<div role="group" class="bui-group bui-group--inline">
									<button type="button" class="bui-button bui-button--primary">
										<span class="bui-button__text"><span>Update
												preferences</span></span>
									</button>
									<button type="button" class="bui-button bui-button--secondary">
										<span class="bui-button__text"><span>Go back</span></span>
									</button>
								</div>
							</div>
						</div>
