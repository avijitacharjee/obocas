						...
						<div id="main-container" class="container-fluid tfa_phone_alt container-fluid--color">
							<main id="content" class="">
								<div class="page-body ">
									...
									<div
										class="transport-form tf-state-no-journeys tf-state-edit tf-state-airport-only tf-state-edit-type">
											...
											<div class="col-sm-6">
												...
												<div class="journey_form_wrap tf-edit">
													...
													<div class="starting tf-set-type tf-hide-if_airport-only">
														<span class="start-icon">네</span>Train station</div>
													<div class="starting tf-set-type tf-hide-if_airport-only">
														<span class="start-icon">덄</span>Other starting point</div>
													<div class="journey_form tf-content">
														...
														<div
															...
															<div class="row">
																...
																<div class="col-md-7 form-field">
																	<select name="from" class="form-control">
																		<option value="235" list_count="0">Hazrat
															...
															<div
																class="row tf-hide tf-show-if_bus tf-show-if_metro tf-show-if_tram">
															...
															<div class="tf-hide tf-show-if_tt-set-any">
																...
																<div
																	...
																	<div
																		class="row tf-hide tf-show-if_shuttle_property">
																		<label
																			class="col-md-8 col-md-offset-4 trans-checkbox-label">
																			<input type="checkbox"
																				name="available_upon_arrangement"
														...
														<div class="leg tf-start-leg tf-tab tf-tab_id-train">
															<div class="tf-field-set">
																...
																<div
																	...
																	<div class="col-md-7 form-field">
																		<input type="text"
																			class="form-control tf-free-text"
																			maxlength="255">
																	</div>
																</div>
															</div>
														...
														<div class="leg tf-start-leg tf-tab tf-tab_id-other">
															...
															<div class="row">
																...
																<div class="col-md-7 form-field">
																	<select name="transport_type" class="form-control"
																		data-collection="transport_type"
																...
																<div class="tf-extra tf-extra_expanded">
																	<div class="row extra_options">
																		...
																		<div class="col-md-4 col-xs-6 form-field">
																			<input type="text" class="form-control"
																				name="duration" data-validation="number"
																				autocomplete="off" maxlength="255">
																		</div>
																	...
																	<div class="row extra_options">
																		...
																		<div class="col-md-4 col-xs-6 form-field">
																			<input type="text" class="form-control"
																				name="price" data-validation="number"
																				autocomplete="off" maxlength="255">
																		</div>
																		<div class="col-md-4 col-xs-6 form-label"
																			data-var="currency_code">USD</div>
																	</div>
																</div>
															</div>
															<a href="{{ url("#") }}"
																class="form-cancel pull-right tf-cancel-type">Cancel</a>
															<input type="submit" class="btn btn-primary tf-submit"
																value="Save">
