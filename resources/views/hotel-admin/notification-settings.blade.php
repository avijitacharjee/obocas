                            ...
                            <div class="page-body ">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 main-content">
                                        <form role="form" class="show-when-ready" id="add_property_details" action="#"
                                            method="POST">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio-block" id="arrival_notification">
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="arrival_notification"
                                                                    value="yes">
                                                                <span>Yes</span>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="arrival_notification_email_at"
                                                                    name="arrival_notification_email_at"
                                                        ...
                                                        <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="arrival_notification_email"
                                                                    name="arrival_notification_email"
                                                                    class="form-control " style="">
                                                                    <option value="370577015">litoncomar95@gmail.com |
                                                                        Md masum Mazumder | +8801838024795</option>
                                                                </select>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio-block" id="receive_sms">
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="receive_sms" value="yes">
                                                                <span>Yes</span>
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="receive_sms" value="no"
                                                                    checked="">
                                                                <span>No</span>
                                                            </label>
                                                        </div>
