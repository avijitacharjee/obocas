						...
						<div class="bui-container bui-container--center">
							...
							<div class="bui-grid">
								<div class="bui-grid__column-full bui-grid__column-8@medium">
									<div>
										<div class="bui-panel">
											<div class="basic-info-row-name">
												<span>Property name:</span>
											</div>
											<div class="basic-info-row-content">
												time squers
												<div>
													<button class="bui-link bui-link--primary">
														<span>
															Change property
															name</span>
													</button>
											...
											<div class="basic-info-row-content">
												23.799898, 90.420766
												<span>
													(on <a href="{{ url("#") }}" class="bui-link bui-link--primary">Google Maps</a>
													and <a href="{{ url("#") }}"
														class="bui-link bui-link--primary">OpenStreetMap</a>)
												</span>
											</div>
											<hr>
											<div>
												...
												<div>
													<span class="basic-info-row-name">
									...
									<div data-test-id="general-info-host-type-section" class="bui-spacer">
										<h2 class="host-type-title">
											<span>Host-type selection</span>
										</h2>

										<div class="bui-panel">
											<p><span>In order to comply with consumer authority commitments, we must
													collect the following information from partners. This information
													will allow us to communicate to guests whether the property they are
													staying at is run by a professional host or a private host.</span>
											</p>
											<div class="bui-spacer">
												<p><span>For more information, read this
														<a href="{{ url("#") }}" class="bui-link bui-link--primary">article
														</a> in Partner Help.</span>
												</p>
											</div>
											<div class="bui-spacer">
												<p class="bui_font_heading">
													<span>Which option describes you
														best?</span>
												</p>
											</div>
											<div class="bui-spacer">
												<div class="bui-form__group">
													<label class="bui-radio">
														<input id="professionalhost" onclick="UnCheck()" name="host"
															type="radio" checked value="trader"
															class="bui-radio__input">
														<span class="bui-radio__label">
															<div class="bui_font_strong">
																<span>Professional host</span>
															</div>
															<div class="bui_font_caption">
																<span>Any party who is renting
																	out a property or properties for purposes relating
																	to their trade, business, or profession. (Some
																	indicators might be: this is your main business, you
																	are a property management company, collect VAT, have
																	a business name, etc…)</span>
															</div>
														</span>
													</label>
												...
												<div class="bui-form__group">
													<label class="bui-radio">
														<input id="privatehost" onclick="Check()" name="host"
															type="radio" value="non_trader" class="bui-radio__input">
														<span class="bui-radio__label">
															<div class="bui_font_strong">
																<span>Private host /
																	Non-professional host</span>
															</div>
															<div class="bui_font_caption">
																<span>Any party who is renting
																	out a property or properties for purposes which are
																	outside their trade, business, or profession. (For
																	example: this is a side business, you only rent your
																	place occasionally, etc...)</span>
															</div>
														</span>
													</label>
											...
											<button type="button" disabled
												class="bui-button host-button bui-button--primary">
									...
									<div class="bui-spacer">
										<h2 class="prop-manage-title">
											<span>Property Management Information</span>
										</h2>
										<div class="bui-panel">
											<div class="bui-spacer">
												<p>
													<span>At Booking.com, we strive to provide our partners with the
														best
														possible tools, but to do this we need your help. By sharing a
														few details about your property and the systems you’re currently
														using, we can work to build connections with your providers to
														create a seamless experience for you and your guests.</span>
												</p>
												<p>
													<span>It goes without saying, but any data you share with us will be
														highly confidential and will only be used by us internally to
														improve our service to you - it won't be shared outside of
														Booking.com.</span>
												</p>
											</div>
											<div class="bui-spacer">
												<div placeholder="I do not currently use a PMS" disabled="disabled"
													class="bui-form__group">
													<label for="input-text-pms">
														<div class="prop-manage-question">
															<span class="bui_font_strong">
																Which property management system (PMS) are you using?
															</span>
															<button class="prop-manage-question-tooltip bui-link">
													...
													<input id="inputtextpms" type="text"
														placeholder="I do not currently use a PMS" disabled value=""
														class="bui-form__control bui-form__control--disabled ">

												</div>

												<div class="prop-manage-do-not-use-checkbox bui-form__group">
													<label class="bui-checkbox">
														<input type="checkbox" id="inputcheckpms" onclick="Check()"
															checked="checked" class="bui-checkbox__input"> <span
															class="bui-checkbox__label">
															I do not currently use a PMS
														</span>
													</label>
											...
											<div class="bui-spacer">
												<div placeholder="I do not currently use a channel manager or central reservation system."
													disabled="disabled" class="bui-form__group">
													<label for="input-text-cm">
														<div class="prop-manage-question">
															<span class="bui_font_strong">
																Which channel manager or central reservation system are
																you using?
															</span> <button
																class="prop-manage-question-tooltip bui-link"><svg
																	fill="currentColor" height="14" width="14"
																	viewBox="0 0 24 24"
																	class="bk-icon -streamline-question_mark_circle">
																	<path
																		d="M9.75 9a2.25 2.25 0 1 1 3 2.122 2.25 2.25 0 0 0-1.5 2.122v1.006a.75.75 0 0 0 1.5 0v-1.006c0-.318.2-.602.5-.708A3.75 3.75 0 1 0 8.25 9a.75.75 0 1 0 1.5 0zM12 16.5a1.125 1.125 0 1 0 0 2.25 1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z">
													...
													<input id="inputtextcm" type="text"
														placeholder="I do not currently use a channel manager or central reservation system."
														disabled="disabled" value=""
														class="bui-form__control bui-form__control--disabled">

												</div>

												<div class="prop-manage-do-not-use-checkbox bui-form__group"><label
														class="bui-checkbox">
														<input id="inputcheckcm" type="checkbox" onclick="Check2()"
															checked="checked" class="bui-checkbox__input">
														<span class="bui-checkbox__label">
															I do not currently use a channel manager or central
															reservation system.
														</span></label>
											...
											<div class="bui-spacer"></div>
											<div>
												<button type="button" class="bui-button bui-button--primary update-info"
													disabled="disabled">
								...
								<div class="ext-footer__top-content__inner">
									...
									<div class="ext-footer__top-content__second">
										<div class="ext-footer__ctas">
											<a href="{{ url("#") }}" class="ext-footer__cta bui-button bui-button--primary">
												<span class="bui-button__text">
													<span>Add new
														property</span>
												</span>
