					...
					<main class="main">
						<div class="bui-container bui-container--center">
							...
							<div class="bui-page-header">
								...
								<h1 class="bui-page-header__title"><span>Guest reviews</span></h1>

								<p class="bui-page-header__description"><span>Your property hasn't been reviewed yet.
										Keep an eye out for upcoming guest reviews on this page.</span> <br> <span><a
											href="{{ url("#") }}">Click here</a> to see our reviews/replies policy.</span></p>
							</div>

							<div class="bui-grid bui-grid--reversed">
								<div
									class="bui-grid__column-full bui-grid__column-8@large reviews-main-column--reversed">
									<div role="group" id="reviews-main-container" class="bui-group">
								...
								<div class="bui-grid__column-full bui-grid__column-4@large"></div>
							</div>
							...
							<div class="bui-empty-state d-none"><svg data-test-id="default-icon"
								...
								<p class="bui-empty-state__text"><span>Your property has not been reviewed yet.</span>
								</p>
							</div>
