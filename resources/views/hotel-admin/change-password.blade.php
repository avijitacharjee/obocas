                        ...
                        <main id="content" class="">
                            <div class="page-body ">
                                <div class="page-header-component-title th__page-header ">
                                    ...
                                    <div class="row">
                                        <div class=" th__page-header__content col-md-push-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="password-change" method="post" action="#">
                                                ...
                                                <div class="row">
                                                    <div class="describe-block">
                                                        ...
                                                        <ul class="describe-text list-unstyled">
                                                            <li>Your new password should</li>
                                                            <li>- Have at least 8 characters</li>
                                                            <li>- Use at least one letter and one number</li>
                                                            <li>- Be unique each time– for security reasons, please
                                                                don't
                                                                re-use old passwords</li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <input id="save-password" type="submit"
                                                class="btn btn-primary btn-block btn-lg" value="Save">

                                        </form>

                                        <div class="modal fade close-account">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <!-- Step 4. -->
                                                        <h3>Thanks for working with Booking.com. We appreciate your
                                                            feedback
                                                            and are sorry that you're leaving.</h3>

                                                        <div class="alert alert-info">
                                                            <p>Your contract termination request has been submitted and
                                                                will
                                                                be processed by your local support team within 7 working
                                                                days. Until then, you will continue to have access to
                                                                your
                                                                account and are able to receive new reservations.
                                                                However,
                                                                if you do not want to receive new reservations, please
                                                                adjust your availability.</p>

                                                            <p>We may need to contact you for any outstanding issues on
                                                                behalf of the guests who have already made reservations
                                                                with
                                                                you or for any unpaid invoices. You should be aware of
                                                                the
                                                                following details, as listed in the Accommodation
                                                                Agreement:
                                                                "After termination, suspension or closure, the
                                                                Accommodation
                                                                shall honour outstanding reservations for Guests and
                                                                shall
                                                                pay all commissions (plus costs, expenses, interest if
                                                                applicable) due on those reservations in accordance with
                                                                the
                                                                terms of this Agreement."</p>
                                                        </div>

                                                        <p>If you ever wish to re-list your property on Booking.com we
                                                            would
