            ...
            <div class="page-body ">
                ...
                <div class="js-dont-warn-about-unsaved-changes">
                    ...
                    <main id="content" class="main">
                        <div class="js-dont-warn-about-unsaved-changes bui-container bui-container--center">


                            <div id="rcatContainer" class="rp--mobile-friendly">
                                ...
                                <div class="bui-grid">
                                    <div class="bui-grid__column-full bui-grid__column-10@medium bui-grid__column-8@large">
                                        <form id="flexible_rate_form" data-on-submit="submitForm(event)">




                                            <h1>Review your fully flexible rate plan</h1>

                                            <div id="flexible_review" class="bui-container rp-container--no-pading@small">
                                                <div class="form-container form-review">
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 policy-column-6">
                                                                <p>
                                                                    Flexible - 2 days
                                                                </p>
                                                            </div>
                                                            <div class="bui-grid__column-3 policy-column-3">
                                                                <div class="review-edit-button">
                                                                    <button class="bui-button bui-button--secondary policy-button" type="button">
                                                                        <span class="bui-button__text">Edit</span>
                                                                    </button>
                                                                </div>
                                                            </div>

                                                            <div class="bui-grid__column-9 d-none policy-column-9">
                                                                <div class="form-question-fadein">
                                                                    <div id="review_ratePolicyField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="bui-radio ">
                                                                                        <input class="bui-radio__input"
                                                                                            type="radio"
                                                                                            name="rate-policy"><span
                                                                                            class="bui-radio__label">Flexible
                                                                                            -
                                                                                            1 day</span>
                                                                                    </label>
                                                                            ...
                                                                            <div class="recommendation-container">
                                                                                <div class="form-validation neutral-message">

                                                                                    <span>
                                                                                        Fully flexible rates are
                                                                                        generally the most expensive
                                                                                        rates on Booking.com. Guests are
                                                                                        often willing to pay extra for
                                                                                        the freedom to cancel free of
                                                                                        charge and get a full refund.
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatPolicy_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary policy-button-close" type="button"><span
                                                                                    class="bui-button__text">Cancel</span>
                                                                            </button>


                                                                            <button class="bui-button bui-button--primary policy-button-close" type="button"><span
                                                                                    class="bui-button__text">Save</span>
                                                                            </button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 meals-column-6">
                                                                <p>
                                                                    No meals
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="bui-grid__column-3 meals-column-3">
                                                                <div class="review-edit-button">

                                                                    <button class="bui-button bui-button--secondary meals-button" type="button">
                                                                        <span class="bui-button__text">Edit</span>
                                                                    </button>
                                                            ...
                                                            <div class="bui-grid__column-9 meals-column-9 d-none">
                                                                <div class="form-question-fadein">


                                                                    <div id="review_rateMealOptionsField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">
                                                                            ...
                                                                            <div class="bui-radio">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="bui-radio ">
                                                                                        <input class="bui-radio__input"
                                                                                            type="radio"
                                                                                            name="rate-meal-option"
                                                                                            value="no"><span
                                                                                            class="bui-radio__label">No</span></label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="bui-radio ">
                                                                                        <input class="bui-radio__input"
                                                                                            ...
                                                                                            data-ref="label">Yes, add a
                                                                                            meal plan</span></label>
                                                                            ...
                                                                            <div class="checkbox-list">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="bui-form__group "><label class="bui-checkbox"><input
                                                                                                ...
                                                                                                type="checkbox"
                                                                                                value="meals_breakfast"><span
                                                                                                class="bui-checkbox__label">Breakfast</span></label>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="bui-form__group "><label class="bui-checkbox"><input
                                                                                                class="bui-checkbox__input "
                                                                                                type="checkbox"
                                                                                                value="meals_lunch"><span
                                                                                                class="bui-checkbox__label">Lunch</span></label>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="bui-form__group "><label class="bui-checkbox"><input
                                                                                                class="bui-checkbox__input "
                                                                                                type="checkbox"
                                                                                                value="meals_dinner"><span
                                                                                                class="bui-checkbox__label">Dinner</span></label>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="bui-form__group "><label class="bui-checkbox"><input
                                                                                                class="bui-checkbox__input "
                                                                                                type="checkbox"
                                                                                                value="meals_all_inclusive"><span
                                                                                                class="bui-checkbox__label">All
                                                                                ...
                                                                                <div class="recommendation-container">
                                                                                    <div class="form-validation warning-message">

                                                                                        <span class="form-validation-heading">
                                                                                            Keep in mind
                                                                                        </span>
                                                                                        <br>

                                                                                        <span>
                                                                                            54% of bookings are made
                                                                                            without meals. You can
                                                                                            always offer meals to guests
                                                                                            upon arrival.
                                                                                        </span>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatMeal_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary meals-button-close" type="button"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary meals-button-close" type="button"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 stay-column-6">
                                                                <p>
                                                                    <span>No minimum length of stay</span>
                                                                </p>
                                                            </div>

                                                            <div class="bui-grid__column-3 stay-column-3">
                                                                <div class="review-edit-button">

                                                                    <button class="bui-button bui-button--secondary stay-button" type="button">
                                                                        <span class="bui-button__text">Edit</span>
                                                                    </button>
                                                                </div>
                                                            </div>

                                                            <div class="bui-grid__column-9 stay-column-9 d-none">
                                                                <div class="form-question-fadein">


                                                                    <div id="review_rateMinLOSField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">
                                                                            ...
                                                                            <div class="bui-radio">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="bui-radio "><input
                                                                                            class="bui-radio__input"
                                                                                            data-ref="input"
                                                                                            type="radio"
                                                                                            id="review_rateMinLOSNo"
                                                                                            name="rate-min-los"
                                                                                            value="no"
                                                                                            data-on-click="updateRCMinLOSOption(event)"><span
                                                                                            class="bui-radio__label"
                                                                                            data-ref="label">No (this
                                                                                            rate plan is available for
                                                                                            any length of
                                                                                            stay)</span></label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="bui-radio "><input
                                                                                            ...
                                                                                            data-ref="input"
                                                                                            type="radio"
                                                                                            id="review_rateMinLOSYes"
                                                                                            name="rate-min-los"
                                                                                            value="yes"
                                                                                            data-on-click="updateRCMinLOSOption(event)"
                                                                                            checked=""><span
                                                                                            class="bui-radio__label"
                                                                                            data-ref="label">Yes</span></label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input type="number" min="2" max="28" id="review_rateMinLOSNights" name="rate-min-los-nights" value="2" data-on-change="updateRCMinLOSNights(event)">
                                                                                <span>night minimum stay</span>
                                                                            </div>
                                                                            ...
                                                                            <div class="recommendation-container">
                                                                                <div class="form-validation warning-message">
                                                                                    ...
                                                                                    <span>
                                                                                        ...
                                                                                        48% of bookings are made for
                                                                                        only one night. If you set a
                                                                                        minimum length of stay, you are
                                                                                        likely to lose these bookings.
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatMinLOS_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary stay-button-close" type="button"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary stay-button-close" type="button"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 price-column-6">
                                                                <p>
                                                                    <span>
                                                            ...
                                                            <div class="bui-grid__column-3 price-column-3">
                                                                <div class="review-edit-button">

                                                                    <button class="bui-button bui-button--secondary price-button" type="button" data-on-click="editField('rcat_manage')" data-track-ga="Rate Plans,Review,Edit - Price management"><span
                                                                            class="bui-button__text">Edit</span>
                                                                    </button>

                                                                </div>
                                                            </div>

                                                            <div class="bui-grid__column-9 price-column-9 d-none">
                                                                <div class="form-question-fadein">
                                                                    <div id="review_rateManageField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">
                                                                            ...
                                                                            <div class="bui-radio">
                                                                                <div class="form-group">
                                                                                    <label class="bui-radio "><input
                                                                                            ...
                                                                                            data-ref="input"
                                                                                            type="radio"
                                                                                            id="review_rateManageNew"
                                                                                            name="rate-manage"
                                                                                            value="new"
                                                                                            data-on-click="updateRCManageRateOption(event)"><span
                                                                                            class="bui-radio__label"
                                                                                            data-ref="label">Set up as a
                                                                                            new rate plan
                                                                                        </span></label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label class="bui-radio "><input
                                                                                            ...
                                                                                            data-ref="input"
                                                                                            type="radio"
                                                                                            id="review_rateManageExisting"
                                                                                            name="rate-manage"
                                                                                            value="existing"
                                                                                            data-on-click="updateRCManageRateOption(event)"
                                                                                            checked=""><span
                                                                                            class="bui-radio__label"
                                                                                            data-ref="label">Based on
                                                                                            one of my current rate
                                                                                            plans</span></label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <select id="review_rateManageExistingRates" data-on-change="updateRCManageExistingRate(event)">
                                                                            ...
                                                                            <div class="recommendation-container">
                                                                                <div class="form-validation neutral-message">
                                                                                    ...
                                                                                    <span>
                                                                                        ...
                                                                                        way to manage your new rate
                                                                                        plan. It will base its price on
                                                                                        Standard Rate, plus whatever
                                                                                        price increase you set in the
                                                                                        next step. The rate plan will
                                                                                        only be available on
                                                                                        Booking.com. You won't need to
                                                                                        change prices, load availability
                                                                                        or map the rate plan in your
                                                                                        channel manager.
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatManage_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary price-button-close" type="button" data-on-click="editFieldCancel('rcat_manage')"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary price-button-close" type="button" data-on-click="editFieldSave('rcat_manage')"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 difference-column-6">
                                                                <p>
                                                                    US$9 more expensive than Standard Rate

                                                                </p>
                                                            </div>

                                                            <div class="bui-grid__column-3 difference-column-3">
                                                                <div class="review-edit-button">
                                                                    <button class="bui-button bui-button--secondary difference-button" type="button" data-on-click="editField('rcat_discount')" data-track-ga="Rate Plans,Review rate plan,Edit - Price config"><span
                                                                            class="bui-button__text">Edit</span></button>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="bui-grid__column-9 difference-column-9 d-none">
                                                                <div class="form-question-fadein">


                                                                    <div id="review_rateDiscountField" class="form-question form-question-fadein">
                                                                        <div class="form-question-container pad-lg-bottom">

                                                                            <div class="bui-grid">
                                                                                <div class="bui-grid__column-12">
                                                                                    <div class="form-bleed-top-bottom">
                                                                                        <div class="bui-form__group">
                                                                                            <input type="number" min="0" id="review_rateDiscount" name="rate-discount" class="" value="9" data-on-change="updateRCDiscount(event)">
                                                                                            <select id="review_ratePriceSettingUnit" data-on-change="updateRCDiscountType(event)">
                                                                                            ...
                                                                                            <span class="form-vertical-align-child">
                                                                                                more expensive than
                                                                                                Standard Rate
                                                                                            </span>
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatDiscount_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary difference-button-close" type="button" data-on-click="editFieldCancel('rcat_discount')"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary difference-button-close" type="button" data-on-click="editFieldSave('rcat_discount')"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            ...
                                                            <div class="bui-grid__column-6 rooms-column-6">
                                                                <p>
                                                                    Deluxe Double Room
                                                                </p>
                                                            </div>

                                                            <div class="bui-grid__column-3 rooms-column-3">
                                                                <div class="review-edit-button">

                                                                    <button class="bui-button bui-button--secondary rooms-button" type="button"><span
                                                                            class="bui-button__text">Edit</span>
                                                                    </button>
                                                            ...
                                                            <div class="bui-grid__column-9 rooms-column-9 d-none">
                                                                <div class="form-question-fadein">


                                                                    <div id="review_rateRoomsField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="bui-form__group "><label class="bui-checkbox"><input
                                                                                            ...
                                                                                            data-ref="input"
                                                                                            type="checkbox"
                                                                                            id="review_room_796270001"
                                                                                            checked="" value="796270001"
                                                                                            data-on-click="updateRCRooms(event)"><span
                                                                                            class="bui-checkbox__label"
                                                                                            data-ref="label">Deluxe
                                                                                            Double Room</span></label>
                                                                                </div>
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatRooms_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary rooms-button-close" type="button" data-on-click="editFieldCancel('rcat_rooms')"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary rooms-button-close" type="button" data-on-click="editFieldSave('rcat_rooms')"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-review-row">
                                                        <div class="bui-grid">
                                                            <div class="bui-grid__column-3">
                                                                <p><strong>Rate plan name</strong></p>
                                                            </div>

                                                            <div class="bui-grid__column-6 name-column-6">
                                                                <p>Fully flexible</p>
                                                            </div>

                                                            <div class="bui-grid__column-3 name-column-3">
                                                                <div class="review-edit-button">

                                                                    <button class="bui-button bui-button--secondary name-button" type="button">
                                                                        <span class="bui-button__text">Edit</span>
                                                                    </button>
                                                            ...
                                                            <div class="bui-grid__column-9 name-column-9 d-none">
                                                                <div class="form-question-fadein">

                                                                    <div id="review_rateNameField" class="form-question">
                                                                        <div class="form-question-container pad-lg-bottom">

                                                                            <div>
                                                                                <input type="text" class="bui-form__control" id="review_rateName" name="rate-name" value="Fully flexible" maxlength="255" data-on-change="updateRCName(event)">
                                                                    ...
                                                                    <div class="form-cta-row">
                                                                        <div id="rcatName_editCTAField" class="form-cta">

                                                                            <button class="bui-button bui-button--secondary name-button-close" type="button" data-on-click="editFieldCancel('rcat_name')"><span
                                                                                    class="bui-button__text">Cancel</span></button>


                                                                            <button class="bui-button bui-button--primary name-button-close" type="button" data-on-click="editFieldSave('rcat_name')"><span
                                                                                    class="bui-button__text">Save</span></button>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-confirmation positive-message">

                                                            <p>This rate plan will take its price and availability from Standard Rate. Just activate it and you're good to go.
                                                            </p>
                                                    ...
                                                    <div class="form-row">
                                                        <div id="review_rateCTAField" class="form-question">
                                                            <div class="form-question-container-last">

                                                                <a href="{{ url("rate-plans.html") }}" class="bui-button bui-button--secondary bui-button--wide ">
                                                                    <span class="bui-button__text">Go
                                                                        back</span>
                                                                </a>

                                                                <button class="bui-button bui-button--primary bui-button--wide " type="submit">
                                                                    <span class="bui-button__text">Activate rate
                                                                        plan</span>
                                                                </button>
