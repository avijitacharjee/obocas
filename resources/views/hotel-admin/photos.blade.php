...
<head>
	...
	<link rel="stylesheet" href="{{ asset("/hotel-admin/assets/css/pages/photo.min.css") }}">
...
<body>
				...
				<div class="js-dont-warn-about-unsaved-changes">
					...
					<main class="main">
						<div class="bui-container bui-container--center">
							...
							<div class="bui-tab">
								<!-- Tab Button -->
								<ul class="bui-tab__nav filter-button-group">
									<li class="bui-tab__item">
										<button class="bui-tab__link filter_all active" data-filter="*">
											<span>All photos</span>
											<span class="bui-tab__text-slot">
												<span class="bui-bubble">4</span>
											</span>
										</button>
									</li>
									<li class="bui-tab__item">
										<button class="bui-tab__link filter_low" data-filter=".main_gallery">
											<span>Low-quality photos</span>
											<span class="bui-tab__text-slot">
												<span class="bui-bubble bui-bubble--destructive">4</span>
											</span>
										</button>
									</li>
									<li class="bui-tab__item">
										<button class="bui-tab__link filter_missing" data-filter=".deluxeroom">
											<span>Units with missing photos</span>
											<span class="bui-tab__text-slot">
												<span aria-label="1" class="bui-bubble bui-bubble--destructive">1</span>
											</span>
										</button>
									</li>
									<li class="bui-tab__item">
										<button class="bui-tab__link filter_tags" data-filter=".main_gallery">
											<span>Photos with missing tags</span>
											<span class="bui-tab__text-slot">
												<span class="bui-bubble bui-bubble--destructive">4</span>
											</span>
										</button>
								...
								<div class="tab-content grid" id="myTabContent">

									<!-- First Tab -->
									<div class="grid-item">
										<div class="bui-spacer"></div>
										<ul class="bui-accordion">
											<li class="bui-accordion__row">
												<button type="button" class="bui-accordion__row-inner">
													<div class="bui-accordion__row-header">
														<h1 class="bui-accordion__title"></h1>
														<p class="bui-accordion__subtitle">
															<strong>
																<span>Import photos from your Airbnb or VRBO
																	listing</span>
															</strong>
															<br>
															<span class="photo-upload__subtext">
																<span>
																	Guests rely on photos to help them decide where to
																	stay. If you
																	have great shots of your property on Airbnb or VRBO,
																	you can also use them on Booking.com.
																</span>
															</span>
														</p>
													</div>
												...
												<div id="" class="bui-accordion__content">
													<div class="bui-spacer">
														<ol class="bui-nav-progress bui-nav-progress--horizontal">
															<div style="display: contents;">
																...
																<li class="bui-nav-progress__divider"></li>
															</div>
															<div style="display: contents;">
																<li
															...
															<div style="display: contents;">
																<li
																	class="bui-nav-progress__item bui-nav-progress__item--disabled">
																	<span class="bui-nav-progress__indicator">3</span>
																	<strong class="bui-nav-progress__title">
																		<span>Finish</span>
																	</strong>
																	<span class="bui-nav-progress__step">
													...
													<div>
																...
																<div class="bui-grid">
																	<div
																		...
																		<div class="bui-form__group"><label
																				for="ota-url"><span>Paste the link to
																					your Airbnb or VRBO
																					listing</span></label> <input
																				id="ota-url"
																				aria-describedby="describe-ota-url"
																				autocomplete="off" type="text"
																				placeholder="Example: https://www.obocas.com/rooms/xxxxxxxx"
																				class="bui-form__control">
																			<div class="bui-form__helper"
																				id="describe-ota-url"><span
																					class="photo-upload__subtext"><span>View
																						your property page on either
																						Airbnb or VRBO, and copy and
																						paste the link in the URL bar at
														...
														<div role="group" class="bui-group bui-group--inline"><button
																type="button" class="bui-button bui-button--primary"
																disabled="disabled">
																<span
																	class="bui-button__text"><span>Next</span></span></button>
															<button type="button"
																class="bui-button bui-button--secondary bui-accordion_close">
									...
									<div class="photo-uploader grid-item main_gallery">
										<input type="file" multiple="multiple" accept="image/*" class="visually-hidden">
										<div class="gallery-card-container">
											<div class="gallery-card_heading">
												<h2>Main gallery (4 photos)</h2>
											</div>
												...
												<ul class="bulk-actions-list">
													...
													<li>
														<button onclick="deSelect()" type="button"
															class="bui-button bui-button--tertiary disabled_button"
															disabled="disabled">
															<span class="bui-button__text">
																<span>Deselect
																	all</span></span>
													...
													<li>
														<button type="button"
															class="bui-button bui-button--tertiary disabled_button"
															disabled="disabled">
															<span class="bui-button__text"><span>Hide from
																	gallery</span> </span>
														</button>
													</li>
													<li>
														<button type="button"
															class="destructive bui-button bui-button--tertiary disabled_button"
															disabled="disabled">
															<span class="bui-button__text"><span>Delete</span>
															</span></button>
													</li>
												</ul>
												<input type="file" class="add-more-photo">
											</div>
											<div class="gallery-changes__container">
												...
												<div class="gallery-changes__main-block">
													<svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"
														...
														class="gallery-changes__icon bk-icon -streamline-info_sign">
														<path
													...
													<div class="bui-switch bui-switch--reversed">
														<input id="gallery-changes__switch" autocomplete="off"
															type="checkbox" class="bui-switch__trigger">
														<label for="gallery-changes__switch"
															class="bui-switch__hitbox bui-switch__hitbox--on">
															<span class="bui-switch__indicator">
															</span></label>
													</div>
												</div>
											</div>
											...
											<div
												...
												<div
													...
													<div class="photo-item__photo">
														<img src="{{ asset("/hotel-admin/assets/images/main-photo-1.jpg") }}">
														...
														<div class="photo-uploader">
															...
															<div class="photo-item-container-overlay">
																...
																<div class="photo-item-container-controls">
																	<div class="photo-item-checkbox bui-form__group">
																		<label class="bui-checkbox">
																			<input name="image_check"
																				onclick="singleselects()"
																				type="checkbox"
																	...
																	<div
																		class="bui-dropdown bui-dropdown--end dropdown">
																		<button type="button" data-bs-toggle="dropdown"
																			class="bui-dropdown__button bui-button bui-button--secondary dropdown-toggle"
																			id="dropdownMenuButton1"><span
																				class="bui-button__text">
																				<span>Options</span>
																			</span>

																			<svg xmlns="http://www.w3.org/2000/svg"
																				viewBox="0 0 24 24"
																				class="bui-dropdown__arrows">
																				<path
																		...
																		<div id="" aria-labelledby="dropdownMenuButton1"
																			class="bui-dropdown__menu dropdown-menu">
																			<ul class="bui-dropdown__content">

																				<li>
																					<button
																						class="bui-dropdown__item dropdown-item">
																						<span
																							class="bui-dropdown__item-content">
																							<span>Edit or
																								tag</span>
																						</span>
																					</button>
																				...
																				<li>
																					<button
																						class="bui-dropdown__item dropdown-item"><span
																							class="bui-dropdown__item-content">
																							<span>Hide from main
																								gallery</span></span>
																					</button>
																	...
																	<div class="photo-item__drag-icon-container ">
																		<div class="photo-item__drag-icon-wrapper">
																			<svg width="12" height="12"
																				fill="currentColor" viewBox="0 0 24 24"
																				role="presentation" aria-hidden="true"
																				focusable="false"
																				class="bk-icon -streamline-maximize">
																				<path
																					d="M9.22 13.718l-9 9a.75.75 0 1 0 1.06 1.06l9-9a.75.75 0 1 0-1.06-1.06zM24 7.498V.748a.75.75 0 0 0-.75-.75H16.5a.75.75 0 0 0 0 1.5h6.75l-.75-.75v6.75a.75.75 0 0 0 1.5 0zm-24 9v6.75c0 .414.336.75.75.75H7.5a.75.75 0 0 0 0-1.5H.75l.75.75v-6.75a.75.75 0 0 0-1.5 0zM22.72.218l-9 9a.75.75 0 1 0 1.06 1.06l9-9a.75.75 0 0 0-1.06-1.06zm-9 14.56l9 9a.75.75 0 1 0 1.06-1.06l-9-9a.75.75 0 1 0-1.06 1.06zM1.5 7.498V.748l-.75.75H7.5a.75.75 0 0 0 0-1.5H.75a.75.75 0 0 0-.75.75v6.75a.75.75 0 0 0 1.5 0zm21 9v6.75l.75-.75H16.5a.75.75 0 0 0 0 1.5h6.75a.75.75 0 0 0 .75-.75v-6.75a.75.75 0 0 0-1.5 0zM.22 1.278l9 9a.75.75 0 1 0 1.06-1.06l-9-9a.75.75 0 1 0-1.06 1.06z">
																				</path>
																			</svg></div> <span
																			class="photo-item-cta"><span>Click to
																				edit</span></span>
																	</div>
																</div>
														...
														</div> <span class="photo-item__preferred-badge">
															<span>Preferred
																main photo</span>
														</span>
												...
												<div
													class="photo-item-container photo-item-container__draggable bui-grid__column-6 bui-grid__column-3@medium bui-grid__column-2@large">
													<div t class="photo-item__photo">
														<img src="{{ asset("/hotel-admin/assets/images/main-photo-2.jpg") }}">
														<div class="photo-item__tag-warning">
															<svg width="16" height="16" color="#FEBB02" fill="#FEBB02"
																viewBox="0 0 24 24" role="presentation"
																aria-hidden="true" focusable="false"
												...
												<div
													class="photo-item-container photo-item-container__draggable bui-grid__column-6 bui-grid__column-3@medium bui-grid__column-2@large">
													<div class="photo-item__photo"><img
															src="{{ asset("/hotel-admin/assets/images/main-photo-3.jpg") }}">
														<div class="photo-item__tag-warning"><svg width="16" height="16"
																color="#FEBB02" fill="#FEBB02" viewBox="0 0 24 24"
																role="presentation" aria-hidden="true" focusable="false"
																class="bk-icon -streamline-label">
																<path
																	d="M.311 2.56v6.257a3.75 3.75 0 0 0 1.098 2.651l11.56 11.562a2.25 2.25 0 0 0 3.182 0l6.88-6.88a2.25 2.25 0 0 0 0-3.181L11.468 1.408A3.75 3.75 0 0 0 8.818.31H2.56a2.25 2.25 0 0 0-2.25 2.25zm1.5 0a.75.75 0 0 1 .75-.75h6.257a2.25 2.25 0 0 1 1.59.659l11.562 11.56a.75.75 0 0 1 0 1.06l-6.88 6.88a.75.75 0 0 1-1.06 0L2.47 10.409a2.25 2.25 0 0 1-.659-1.59V2.56zm5.25 3.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0zm1.5 0a2.25 2.25 0 1 0-4.5 0 2.25 2.25 0 0 0 4.5 0z">
														...
														<div class="photo-uploader"><input type="file"
															...
															<div class="photo-item-container-overlay">
																...
																<div class="photo-info-container">
																	<div class="warning-icon-container"><svg width="16"
												...
												<div
													...
													<div class="photo-item__photo">
														...
														<img src="{{ asset("/hotel-admin/assets/images/main-photo-4.jpg") }}">
														<div class="photo-item__tag-warning"><svg width="16" height="16"
																color="#FEBB02" fill="#FEBB02" viewBox="0 0 24 24"
																role="presentation" aria-hidden="true" focusable="false"
																class="bk-icon -streamline-label">
												...
												<div
													class="photo-item-container bui-grid__column-6 bui-grid__column-3@medium bui-grid__column-2@large">
													<div class="photo-item__empty">
														<input type="file" class="photo-item__empty_input">
														<div class="add-photo-container">
															<svg width="24" height="24" fill="currentColor"
																viewBox="0 0 24 24" role="presentation"
																aria-hidden="true" focusable="false"
																class="bk-icon -streamline-landscape">
																<path
									...
									<!-- Introducing 360° Photos -->
									<div class="photo-uploader grid-item 360photo">
										<input type="file" multiple="multiple" accept="image/*" class="visually-hidden">
										<div class="panoramic-gallery-card-container">
											<div class="panoramic-gallery-card_heading">
												<div>
													<span class="bui-f-font-display_one">
														<span>Introducing 360° Photos on your Property Page</span>
													</span>
													<div class="panoramic-gallery-card_subtitle">
														<div>
															<span>
																We're looking to help you provide the best possible
																reservation experience for our guests. That's why we are
																currently collecting high-quality 360° photos, to better
																engage and surprise people who are visiting your
																property page.
															</span>
														</div>
													</div>
												</div>
												<input type="file" class="add-photo">
											</div>
											<div class="panoramic-photo-list-container bui-grid"></div>
										</div>
									</div>
									<!-- /Introducing 360° Photos -->

									<!-- Deluxe Double Room (0 photos) -->
									<div class="photo-uploader grid-item deluxeroom">
										<div class="gallery-card-container">
											<div class="gallery-card_heading">
												<h2>Deluxe Double Room (0 photos)</h2>
											</div>
											<div role="status" class="bui-alert bui-alert--inline bui-alert--info">
												...
												<div class="bui-alert__description">
													<p class="bui-alert__text">
														<span>Please add at least 4 photos. You
															can drag and drop multiple photos here.</span>
													</p>
												</div>
											</div>
											<div
							...
							<p class="photo-page-footer">
								<span>For policies related to the usage of photos please see
									our
	...
	<div id="" class="edit-photo-modal bui-modal ">
		<div class="bui-modal__wrapper">
			<div class="bui-modal__align">
				<aside class="bui-modal__content bui-f-depth-1">

					<div class="bui-modal__body edit-photo-modal__body">
						<div class="photo-modal-container bui-grid bui-grid--bleed bui-grid--reversed">
							<div class="bui-grid__column-12">
								<div role="status" class="photo-modal-alert bui-alert bui-alert--info"><span
									...
									<div class="bui-alert__description"><span class="bui-alert__title"><span>Replace
												this photo</span></span>
										<p class="bui-alert__text"><span>Your photos will have the greatest impact with
												guests if they are at least 1280x900 pixels.</span></p>

									</div>
								</div>
							</div>
							<div class="photo-carousel bui-grid__column-12 bui-grid__column-8@large">
								<!-- <button
									class="navigation-button navigation-button-left"><svg width="20" height="20"
										fill="currentColor" viewBox="0 0 24 24" role="presentation" aria-hidden="true"
										focusable="false" class="bui-carousel__prev bk-icon -streamline-arrow_nav_left">
										<path
								...
								<div class="photo-container">
									<div class="photo-controls-wrapper">
										<img id="rotate-photo" src="{{ asset("/hotel-admin/assets/images/property.jpg") }}">
										<div class="edit-photo-controllers">

											<button class="photo-controller">
												<svg width="32" height="32" color="#fff" fill="#fff" viewBox="0 0 24 24"
													role="presentation" aria-hidden="true" focusable="false"
													class="bk-icon -streamline-trash">
													<path
														d="M1.5 5.25h21a.75.75 0 0 0 0-1.5h-21a.75.75 0 0 0 0 1.5zM14.25.75h-4.5A2.25 2.25 0 0 0 7.5 3v1.5c0 .414.336.75.75.75h7.5a.75.75 0 0 0 .75-.75V3A2.25 2.25 0 0 0 14.25.75zm0 1.5A.75.75 0 0 1 15 3v1.5l.75-.75h-7.5L9 4.5V3a.75.75 0 0 1 .75-.75h4.5zm-3.75 15v-7.5a.75.75 0 0 0-1.5 0v7.5a.75.75 0 0 0 1.5 0zm4.5 0v-7.5a.75.75 0 0 0-1.5 0v7.5a.75.75 0 0 0 1.5 0zm3.118 3.812a.75.75 0 0 1-.748.688H6.631a.75.75 0 0 1-.748-.688L4.497 4.438l-.747.812h16.5l-.747-.812-1.385 16.624zm1.494.124l1.385-16.624a.75.75 0 0 0-.747-.812H3.75a.75.75 0 0 0-.747.812l1.386 16.624A2.25 2.25 0 0 0 6.63 23.25H17.37a2.25 2.25 0 0 0 2.242-2.064z">
													</path>
												</svg>
											</button>

											<button class="photo-controller rotate-photo-left" onclick="turnFan()">
												<svg width="32" height="32" fill="#fff" viewBox="0 0 128 128"
													role="presentation" aria-hidden="true" focusable="false"
													class="bk-icon -streamline-update">
													<path
														d="M128 102.63a4 4 0 0 1-4 4H98.23a4 4 0 0 1-4-4V76.87a4 4 0 0 1 8 0v16.54a.347.347 0 0 1 .07-.1c.38-.56.76-1.12 1.11-1.68v-.08c15.142-24.188 7.808-56.071-16.38-71.213C62.842 5.195 30.96 12.53 15.817 36.717.675 60.905 8.01 92.788 32.197 107.93a51.672 51.672 0 0 0 47.263 3.91 4 4 0 1 1 3.08 7.38c-30.539 12.386-65.336-2.329-77.722-32.868C-7.174 56.785 6.215 23.016 35.21 9.7a3.86 3.86 0 0 1 1.36-.94c30.527-12.661 65.538 1.822 78.2 32.35a59.84 59.84 0 0 1 2.44 38.73 59.004 59.004 0 0 1-8.87 18.79H124a4 4 0 0 1 4 4z">
													</path>
												</svg>
											</button>
											<button class="photo-controller rotate-photo-right" onclick="turnFan()">
												<svg width="32" height="32" fill="#fff" viewBox="0 0 128 128"
													role="presentation" aria-hidden="true" focusable="false"
													class="bk-icon -streamline-update">
													<path
									...
									</div> <span>For policies related to the usage of photos please see our <a
											target="_blank" href="https://partner.booking.com/en-gb/node/2289">photo
											policies</a>.</span>
								</div>
								<!-- <button class="navigation-button navigation-button-right"><svg width="20"
										height="20" fill="currentColor" viewBox="0 0 24 24" role="presentation"
										aria-hidden="true" focusable="false"
										class="bui-carousel__next bk-icon -streamline-arrow_nav_right">
										<path
							...
							<div class="photo-modal-sidebar bui-grid__column-12 bui-grid__column-4@large">
								<div data-v-e3e81f96="" class="bui-form__group"><label class="bui-checkbox"><input
											autocomplete="off" type="checkbox" class="bui-checkbox__input"> <span
											class="bui-checkbox__label"><span data-v-e3e81f96="">Include in your main
												gallery</span> <span data-v-e3e81f96=""
												class="photo-edit-main-gallery-icon"><svg data-v-e3e81f96="" width="14"
													height="14" fill="currentColor" viewBox="0 0 24 24"
													role="presentation" aria-hidden="true" focusable="false"
													class="bk-icon -streamline-info_sign" slot="icon">
													<path
														d="M14.25 15.75h-.75a.75.75 0 0 1-.75-.75v-3.75a1.5 1.5 0 0 0-1.5-1.5h-.75a.75.75 0 0 0 0 1.5h.75V15a2.25 2.25 0 0 0 2.25 2.25h.75a.75.75 0 0 0 0-1.5zM11.625 6a1.125 1.125 0 1 0 0 2.25 1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z">
													</path>
												</svg></span> </span></label>
								...
								<div class="photo-tags">
									<h3 class="photo-tags-header"><span>Tags applied to this photo</span> <span
											class="photo-tags-desc">
											&nbsp;-&nbsp;
											<span>Why tag photos?</span> <svg width="14" height="14" fill="currentColor"
												viewBox="0 0 24 24" role="presentation" aria-hidden="true"
												focusable="false" class="bk-icon -streamline-info_sign">
												<path
													d="M14.25 15.75h-.75a.75.75 0 0 1-.75-.75v-3.75a1.5 1.5 0 0 0-1.5-1.5h-.75a.75.75 0 0 0 0 1.5h.75V15a2.25 2.25 0 0 0 2.25 2.25h.75a.75.75 0 0 0 0-1.5zM11.625 6a1.125 1.125 0 1 0 0 2.25 1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z">
												</path>
											</svg> </span></h3>
									<p class="photo-tag-empty"><span>No tags applied yet</span></p>
									<h5 class="suggested-title"><span>Select tags for this photo
										</span></h5>

								</div>
								<div class="photo-tag-search"><button type="button"
										class="bui-button bui-button--secondary"><span class="bui-button__icon"><svg
												width="16" height="16" fill="currentColor" viewBox="0 0 24 24"
												role="presentation" aria-hidden="true" focusable="false"
												class="bk-icon -streamline-magnifying_glass">
												<path
													d="M17.464 6.56a8.313 8.313 0 1 1-15.302 6.504A8.313 8.313 0 0 1 17.464 6.56zm1.38-.586C16.724.986 10.963-1.339 5.974.781.988 2.9-1.337 8.662.783 13.65c2.12 4.987 7.881 7.312 12.87 5.192 4.987-2.12 7.312-7.881 5.192-12.87zM15.691 16.75l7.029 7.03a.75.75 0 0 0 1.06-1.06l-7.029-7.03a.75.75 0 0 0-1.06 1.06z">
												</path>
											</svg></span> <span class="bui-button__text"> <span>Find other
												tags</span></span></button></div>
								<div class="rooms-list__container">
									<div role="group" class="rooms-list bui-group">
										<h4><span>Indicate if this is a room photo:</span></h4>
										<div class="bui-form__group"><label class="bui-checkbox"><input
													autocomplete="off" type="checkbox" id="796270001"
													class="bui-checkbox__input" value="796270001"> <span
								...
								<div class="photo-modal-footer"><button type="button"
										class="photo-modal-button-finish bui-button bui-button--primary">
										<span class="bui-button__text"><span>Finish</span></span></button></div>
							</div>
						</div>
					</div>
					<button type="button" class="bui-modal__close"><svg xmlns="http://www.w3.org/2000/svg"
			...
			<div data-test-id="overlay" class="bui-modal__overlay"></div>
		</div>
	</div>
