						...
						<div class="ext-header__container">
							...
							<div class="ext-header__side-items">
								<div class="ext-search__bar">
									<!-- <div class="ext-search__overlay"></div> -->
					...
					<main class="main">
						<div class="bui-container bui-container--center">
							<div class="bui-page-header">
								...
								<h1 class="bui-page-header__title"><span>Invoices</span></h1>


							</div>
							<div class="bui-spacer--large">
								<div class="bui-spacer--medium"><span>We produce your invoices based on the check-out
										dates of your reservations.</span></div> <span>Legal company name</span> <button
							...
							<div class="bui-spacer--large">
								<div class="bui-card">
									<div class="bui-card__content">
										...
										<div class="bui-spacer--large finance-outstanding-invoice-table__main-heading">
											<span>Outstanding balances</span></div>
											...
											<table class="table">
												<thead class="bui-table__head">
													<tr class="bui-table__row">
														...
														<th
															class="bui-table__cell bui-table__cell--head bui-table__cell--align-end">
															Amount
														</th>
													</tr>
												</thead>
							...
							<div class="bui-card">
								<div class="bui-card__content">
									...
									<div class="finance-invoice-table-header">
										<div class="finance-invoice-table-header__year-filter-container">
											<span class="finance-invoice-table-header__filter-by-year">Filter by
												year
											</span>

											<div class="dropdown bui-dropdown">
												<button
												...
												<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
													...
													<li>
														<button id="2022" role="link" tabindex="0"
