					...
					<main class="main">
						<div class="bui-container bui-container--center">
							<div role="group" class="bui-group">
								<div aria-label="Go back to policies" role="navigation"
									class="bui-breadcrumb bui-breadcrumb--back">
									<div class="bui-breadcrumb__item"><svg role="presentation"
											xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16"
											height="16" class="bui-breadcrumb__icon">
											<path
							...
							<div class="bui-grid">
								<div class="bui-grid__column-full bui-grid__column-8@large">
									<div class="bui-spacer">
										<div class="bui-panel-group">
											<div class="bui-panel">
												<div class="bui-spacer--large"><span class="bui-f-font-strong">Do your
														guests pay a damage deposit?</span></div>
												<div role="group" class="bui-group bui-group--inline">
													<div class="bui-form__group"><label class="bui-radio"><input
																id="depositRequiredY" autocomplete="off" type="radio"
																name="depositRequired" class="bui-radio__input"
																value="true"> <span
																class="bui-radio__label"><span>Yes</span></span></label>

													</div>

													<div class="bui-form__group"><label class="bui-radio"><input
																id="depositRequiredN" autocomplete="off" type="radio"
																name="depositRequired" class="bui-radio__input"
																value="false"> <span
																class="bui-radio__label"><span>No</span></span></label>
											...
											<div class="bui-panel">
												<div class="bui-grid__column-full bui-grid__column-6@large">
													<div class="bui-spacer--largest">
														<div class="bui-form__group"><label for="ddAmount"><span
																	class="bui-f-font-strong">Enter the damage deposit
																	amount (per stay)</span></label>
															<div
																class="bui-input__group bui-text-input__group bui-text-input__group--prepend">
																<div data-test-id="prepend-slot"
																	class="bui-input__addon"><span>US$</span> <span> per
																		stay</span></div> <input id="ddAmount"
																	aria-describedby="describe-ddAmount"
													...
													<div role="group" class="bui-group">
														<div class="bui-spacer">
															<div role="status"
																class="bui-alert bui-alert--inline bui-alert--info">
																...
																<div class="bui-alert__description">
																	...
																	<p class="bui-alert__text"><span>Currently, your
																			property is only eligible to accept damage
																			deposits through cash payments.</span></p>
														...
														<ul class="bui-list bui-list--unordered">
															<li class="bui-list__item">
																<div class="bui-list__description"><span
																		class="bui-list__description-title"><span>How do
																			you want to collect this
																			payment?</span></span> <span
																		class="bui-list__description-subtitle"><span>You
																			can collect damage deposits in cash when the
																			guest arrives at your
																			property.</span></span></div>
															</li>
															<li class="bui-list__item">
																<div class="bui-list__description"><span
																		class="bui-list__description-title"><span>How do
																			you want to return the damage
																			deposit?</span></span> <span
																		class="bui-list__description-subtitle"><span>You
																			should return the full deposit on the day of
																			check-out unless there’s damage to the
																			property.</span></span></div>
															</li>
														</ul>
													</div>
								...
								<div class="bui-grid__column-full bui-grid__column-4@large">
									<div class="bui-spacer">
										<div class="bui-panel">
											<div class="bui-spacer"><span class="bui-f-font-display_one">Preview of your
													policies</span></div>
											<div class="bui-spacer--large"><span class="bui-f-font-heading">Damage
													deposit</span></div>
											<ul class="bui-list bui-list--unordered">
												<li class="bui-list__item"><span>You collect this from your guests: Upon
														arrival</span></li>
												<li class="bui-list__item"><span>You return this to your guests: The day
														they check-out</span></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="bui-spacer--larger">
										<div role="group" class="bui-group bui-group--inline"><button type="button"
											...
											<a href="{{ url("policies.html") }}"
												...
												<span class="bui-button__text"><span>Cancel</span></span></a>
										</div>
									</div>

									<div class="bui-spacer">
										<div class="ext-feedback-cta bui-f-font-strong">
											<div class="ext-feedback-thumbs"><span
													possible-tags="ext_footer_feedback_share_feedback_cta">Does this
													page have all the info you need?</span> <button
													class="ext-feedback__rating"><svg width="16" height="16"
														fill="currentColor" viewBox="0 0 24 24" role="presentation"
														aria-hidden="true" focusable="false"
													...
													</svg></button> <button class="ext-feedback__rating"><svg width="16"
