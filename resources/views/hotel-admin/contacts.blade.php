...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/hotel-admin/assets/css/pages/contacts.min.css") }}">
                    ...
                    <div class="bui-container bui-container--center">
                        <main id="content" class="">
                            <div class="page-body ">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 page_description">
                                        <p>Set your contacts, bank details and password options from this section.</p>
                                    </div>
                                </div>

                                <div class="row no-accordion" id="accordion">
                                    <div class="col-xs-12 col-sm-6 col-lg-6 panel">
                                        <h3>
                                            <a href="{{ url("#contact-password") }}" data-parent="#accordion" class="accordion-link">
                                                <span
                                                    class="glyphicon glyphicon-chevron-down submenu_arrow"></span><span
                                                    class="glyphicon glyphicon-chevron-right submenu_arrow"></span>

                                                Your Extranet account</a>
                                        </h3>

                                        <div class="js-to-be-collapsed" id="contact-password">
                                            <p class="contact-subhead">This contact information is for verification
                                                purposes only. It will not be shared with anyone. We'll send a
                                                notification to this email address whenever you update your password.
                                            </p>

                                            <div class="col-xs-6 col-sm-12 col-md-12 col-lg-6 contact-block">
                                                <div class="contact-box">
                                                    <div class="block_header contact-name">
                                                        <h4>Login Contact</h4>
                                                    </div>

                                                    <div class="block_details contact-details">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p>
                                                                            ...
                                                                            <a href="{{ url("#") }}"
                                                                                class="contact-item contact-email CT_hidden btn-link">litoncomar95@gmail.com</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <p>
                                                                            <span title="Preferred language"
                                                                                class="glyphicon glyphicon glyphicon-globe"></span>
                                                                            <span
                                                                                class="contact-item contact-mobile">English
                                                                                (UK)</span>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6 panel">
                                        <h3>
                                            <a href="{{ url("#contact-general") }}" data-parent="#accordion" class="accordion-link">
                                                <span
                                                    class="glyphicon glyphicon-chevron-down submenu_arrow"></span><span
                                                    class="glyphicon glyphicon-chevron-right submenu_arrow"></span>

                                                Primary point of contact</a>
                                        ...
                                        <div class="js-to-be-collapsed" id="contact-general">
                                            <p class="contact-subhead">This is the point of contact provided to guests
                                                in their booking confirmation.</p>

                                            <div class="col-xs-6 col-sm-12 col-md-12 col-lg-6 contact-block">
                                                <div class="contact-box">
                                                    <div class="block_header contact-name">
                                                        <h4>Md masum Mazumder</h4>
                                                        <h5>Unknown</h5>
                                                    </div>
                                                    ...
                                                    <div class="block_details contact-details">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p>
                                                                            <span title="Email address"
                                                                                class="glyphicon glyphicon-envelope"></span>
                                                                            <a href="{{ url("mailto:litoncomar95@gmail.com") }}"
                                                                                class="contact-item contact-email CT_hidden btn-link">litoncomar95@gmail.com</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <p>
                                                                            ...
                                                                            <span
                                                                                class="CT_hidden contact-item contact-telephone1">+8801838024795</span>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <div>
                                                            <!-- buttons -->
                                                            <a class="edit-room btn-default btn btn-sm" href="{{ url("#") }}">
                                                                Edit
                                                            </a>
