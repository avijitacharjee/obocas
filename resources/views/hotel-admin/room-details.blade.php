									...
									<div id="room_summaries">
										<div class="row">
											<div class="col-xs-12 col-sm-6 col-lg-4">
												<div class="roomcard large-roomcard">
													...
													<div class="roomcard-content">
														...
														<p>Maximum guests: <b>2 guests</b></p>
														<p>Maximum adults: <b>2 adults</b></p>
														<p>Maximum children: <b>1 child</b></p>
														<p></p>
														...
														<div class="roomcard-buttons">
															<a href="{{ url("edit-room-details.html") }}"
											...
											<div class="col-xs-12 col-sm-6 col-lg-8" id="create-new-room-container">
												<div class="row">
													<div class="col-6">
														<a href="{{ url("edit-room-details.html") }}" id="create-new-room"
