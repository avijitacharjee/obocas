                        ...
                        <div class="js-dont-warn-about-unsaved-changes bui-container bui-container--center">
                            ...
                            <div id="ratePlansContainer" class="rp--mobile-friendly">
                                ...
                                <div class="bui-page-header ">
                                    <h1 class="bui-page-header__title">Add a new rate plan</h1>
                                    <div class="bui-page-header__actions">
                                        <a href="{{ url("rate-plans.html") }}"
                                            class="bui-button bui-button--secondary bui-button--wide "><span
                                                class="bui-button__text">Back</span>
                                            </a>
                                        </div>
                                </div>
                                <div>
                                    ...
                                    <div>
                                        <div class="bui-spacer">
                                            <h1 class="bui-card__title">Increase bookings and reduce cancellations</h1>
                                            <p class="bui-f-font-defaults bui-f-color-grayscale">These rate plans will
                                                give you a solid foundation for your pricing strategy.</p>
                                        </div>
                                    </div>

                                    <div class="bui-panel-group bui-spacer">

                                        <div class="bui-panel">
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">

                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">Fully
                                                                flexible</h1>

                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Let guests cancel for free
                                                        and they'll boost your bookings and revenue</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large"
                                                    allign="end">
                                                    <div class="rp-selector-row__content">

                                                        <a href="{{ url("add-new-rate-plan-final.html") }}"
                                                            class="bui-button bui-button--secondary bui-button--wide ">
                                                            <span
                                                                class="bui-button__text">Add rate plan</span>
                                                            </a>
                                            ...
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">
                                                        ...
                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">
                                                                Non-refundable</h1>
                                                ...
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Reduce cancellations by
                                                        attracting guests who are sure of their dates</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large"
                                                    allign="end">
                                                    <div class="rp-selector-row__content">
                                    ...
                                    <div>
                                        <div class="bui-spacer">
                                            <h1 class="bui-card__title">Attract a wider range of guests</h1>
                                            <p class="bui-f-font-defaults bui-f-color-grayscale">After establishing your
                                                foundation, these rate plans can help you build on it and make your
                                                property more appealing to high-value user groups.</p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">
                                                        ...
                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">Weekly</h1>
                                                            <span class="bui-badge bui-badge--constructive">New</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Stand out to guests looking
                                                        to stay longer than 1 week</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large"
                                                    allign="end">
                                                    <div class="rp-selector-row__content">
                                                        ...
                                                        <a href="{{ url("add-new-rate-plan-final.html") }}"
                                                            class="bui-button bui-button--secondary bui-button--wide "><span
                                                                class="bui-button__text">Add rate plan</span></a>
                                            ...
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">
                                                        ...
                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">Monthly</h1>
                                                            <span class="bui-badge bui-badge--constructive">New</span>
                                                ...
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Earn more stable income from
                                                        guests who stay 28+ nights</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large">
                                                    <div class="rp-selector-row__content">
                                            ...
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">
                                                        ...
                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">Early booker
                                                            </h1>
                                                ...
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Get more bookings earlier by
                                                        attracting guests who plan ahead</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large"
                                                    allign="end">
                                                    <div class="rp-selector-row__content">
                                    ...
                                    <div>
                                        <div class="bui-spacer">
                                            <h1 class="bui-card__title">Custom plan</h1>
                                            <p class="bui-f-font-defaults bui-f-color-grayscale">Set up a rate plan
                                                tailored to your property and business goals.</p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="bui-grid">
                                                <div class="bui-grid__column-full bui-grid__column-4@large">
                                                    <div class="bui-card bui-card--transparent">
                                                        ...
                                                        <div
                                                            class="bui-card__content rp-selector-row__badge-container--alt">
                                                            <h1 class="bui-card__title bui-u-inline@small">Custom</h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-6@large">
                                                    <span class="rp-selector-row__content">Customise a rate plan to suit
                                                        your needs</span>
                                                </div>
                                                <div class="bui-grid__column-full bui-grid__column-2@large"
                                                    allign="end">
