                                                    ...
                                                    <a href="{{ url("#") }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <svg width="16" height="16" fill="currentColor"
                                                                ...
                                                                focusable="false" class="bk-icon -streamline-city"
                                                                slot="icon">
                                                                <path
                                        ...
                                        <button class="ext-action-menu__section" type="button" data-bs-toggle="dropdown"
                                            ...
                                            <div class="ext-action-menu__avatar ext-action-menu__avatar--account">
                                                <svg height="20" viewBox="0 0 24 24" fill="currentColor" width="20"
                                                    role="presentation" focusable="false" slot="icon"
                                        ...
                                        <ul class="ext-navigation-top-item__list">
                                                ...
                                                <a href="{{ url("#") }}" class="ext-navigation-top-item__link">
                                                    <span class="ext-navigation-top-item__icon">
                                                        <svg height="24" viewBox="0 0 24 24" fill="currentColor"
                                                            width="24" role="presentation" focusable="false"
                                                            class="bk-icon -streamline-house">
                                                            <path
                                            ...
                                            <li class="ext-navigation-top-item">
                                                ...
                                                <button class="ext-navigation-top-item__link dropdown-toggle"
                                                    ...
                                                    <span class="ext-navigation-top-item__icon">
                                                        <svg focusable="false" role="presentation" width="24"
                                                            viewBox="0 0 24 24" fill="currentColor" height="24"
                                                            class="bk-icon -streamline-calendar">
                                                            <path
                                            ...
                                            <li class="ext-navigation-top-item">
                                                <a href="{{ url("reservations.html") }}" class="ext-navigation-top-item__link">
                                                    <span class="ext-navigation-top-item__icon">
                                                        <svg focusable="false" role="presentation" width="24"
                                                            fill="currentColor" viewBox="0 0 24 24" height="24"
                                                            class="bk-icon -streamline-list">
                                                            <path
                                            ...
                                            <li class="ext-navigation-top-item ext-navigation-top-item--active">
                                                ...
                                                <button class="ext-navigation-top-item__link dropdown-toggle"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="ext-navigation-top-item__icon">
                                                        <svg width="24" focusable="false" role="presentation"
                                                            viewBox="0 0 24 24" fill="currentColor" height="24"
                                                            class="bk-icon -streamline-edit">
                                                            <path
                                                    ...
                                                    <span class="ext-navigation-top-item__title">
                                                        ...
                                                        <span class="ext-navigation-top-item__dropdown-indicator">
                                                            <svg fill="currentColor" viewBox="0 0 24 24" height="15"
                                                                focusable="false" role="presentation" width="15"
                                                                class="bk-icon -streamline-arrow_nav_down">
                                                                <path
                                                                    d="M18 9.45c0 .2-.078.39-.22.53l-5 5a1.08 1.08 0 0 1-.78.32 1.1 1.1 0 0 1-.78-.32l-5-5a.75.75 0 0 1 0-1.06.74.74 0 0 1 1.06 0L12 13.64l4.72-4.72a.74.74 0 0 1 1.06 0 .73.73 0 0 1 .22.53zm-5.72 4.47zm-.57 0z">
                                                                </path>
                                                    ...
                                                    <span class="ext-navigation-top-item__dropdown-icon">
                                                        <svg width="24" role="presentation" focusable="false"
                                                ...
                                                <button class="ext-navigation-top-item__link dropdown-toggle"
                                                    ...
                                                    <span class="ext-navigation-top-item__icon">
                                                        <svg height="24" fill="currentColor" viewBox="0 0 24 24"
                                                            ...
                                                            class="bk-icon -streamline-email">
                                                            <path
                                                    ...
                                                    <span class="ext-navigation-top-item__title">
                                                        ...
                                                        <span class="ext-navigation-top-item__dropdown-indicator">
                                                            <svg height="15" fill="currentColor" viewBox="0 0 24 24"
                                                                width="15" role="presentation" focusable="false"
                                                                class="bk-icon -streamline-arrow_nav_down">
                                                                <path
                                                                    d="M18 9.45c0 .2-.078.39-.22.53l-5 5a1.08 1.08 0 0 1-.78.32 1.1 1.1 0 0 1-.78-.32l-5-5a.75.75 0 0 1 0-1.06.74.74 0 0 1 1.06 0L12 13.64l4.72-4.72a.74.74 0 0 1 1.06 0 .73.73 0 0 1 .22.53zm-5.72 4.47zm-.57 0z">
                                                                </path>
                                                ...
                                                <button class="ext-navigation-top-item__link dropdown-toggle"
                                                    ...
                                                    <span class="ext-navigation-top-item__title">
                                                        <span class="ext-navigation-top-item__title-text">Guest
                                                            reviews</span>
                                                        <span class="ext-navigation-top-item__dropdown-indicator">
                                                            <svg focusable="false" role="presentation" width="15"
                                                                fill="currentColor" viewBox="0 0 24 24" height="15"
                                                                class="bk-icon -streamline-arrow_nav_down">
                                                                <path
                                                                    d="M18 9.45c0 .2-.078.39-.22.53l-5 5a1.08 1.08 0 0 1-.78.32 1.1 1.1 0 0 1-.78-.32l-5-5a.75.75 0 0 1 0-1.06.74.74 0 0 1 1.06 0L12 13.64l4.72-4.72a.74.74 0 0 1 1.06 0 .73.73 0 0 1 .22.53zm-5.72 4.47zm-.57 0z">
                                                                </path>
                        ...
                        <div class="row">
                            <div class="col-md-12 main-content">
                                ...
                                <div id="main_content_section">
                                    ...
                                    <form id="room_form" method="POST" class="">

                                        <fieldset id="main-room-form">

                                            <legend><span id="room_name_label">Please select</span></legend>
                                       
                                          
                                            <div class="row room-type-selection-block">
                                                <div class="form-group col-sm-6 col-xs-12">
                                                    <label for="roomtype_id">
                                                        Room type
                                                    </label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6 col-xs-12" id="nr_rooms_wrapper">
                                                    ...
                                                    <input id="num_rooms" class="form-control type-number "
                                                        type="number" value="0" min="0" name="num_rooms">



                                                    <span class="help-block js-total-num-rooms-helper">
                                                        out of 1 room at your property
                                                    </span>
                                                </div>

                                                <div class="form-group col-sm-6 col-xs-12">
                                                    <label class="" for="no_smoking">Smoking policy</label>
                                                    <select id="no_smoking" name="no_smoking" class="form-control "
                                                        style="">

                                                        <option value="1">Non-smoking</option>
                                                        <option value="0">Smoking</option>
                                                        <option value="2" selected="">I have both smoking and
                                                            non-smoking options for this room
                                                            type</option>
                                                    </select>
                                                    <span class="help-block"></span>
                                                ...
                                                <div class="form-group col-sm-6 col-xs-12" id="room_near_pool_wrapper">
                                                    <label>
                                                        Room near the pool
                                                    </label>
                                                    <select class="form-control " name="room_near_pool"
                                                        id="room_near_pool">
                                                        <option value="0">
                                                            No selection
                                                        </option>
                                                        <option value="1">
                                                            All these rooms are near the pool
                                                        </option>
                                                    </select>


                                                    <span class="help-block">
                                                        Let your guests know if you have one (or more) of these rooms
                                                        near the pool. They can
                                                        request this when booking based upon your availability.
                                                    </span>
                                                </div>
                                        ...
                                        <fieldset class="room_floor_location_section">
                                            <legend>Room location</legend>

                                            <div class="room_exact_floor_location_section">
                                                <!-- Number of floors -->
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6">
                                                        <label for="number_of_floors_in_building">
                                                            Total number of floors the building has (excl. underground
                                                            floors)
                                                        </label>
                                        ...
                                        <fieldset class="bedding-options missing_info_bedding_target">
                                            <legend>
                                                Bed options
                                            </legend>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 bui-spacer">
                                                    All fields are required
                                                </div>
                                            </div>

                                            <div id="single_room_bedding" class="bed_group">
                                                <div id="alternative_1" class="bedding-group">
                                                    <div>
                                                        <label class="pri-bed-label">Standard arrangement</label>
                                                        <div class="is-block block-display-num-beds-title">

                                                            <label
                                                                class="section-description section-description--type ml-17">What
                                                                kind of
                                                                beds are available in this
                                                                room?
                                                            </label>
                                                            <label class="section-description--subtype">Number of
                                                                beds</label>

                                                            <div id="bed_line_SINGLE_1" class="bed_line ">
                                                                <div class="form-group col-xs-6">
                                                                    <select
                                                                        class="form-control bed_type js-pc-bedding-changes"
                                                                        name="bedtype_id_SINGLE_1"
                                                                ...
                                                                <div class="form-group col-xs-4">
                                                                    <select id="bed_number_SINGLE_1"
                                                                        name="bed_number_SINGLE_1"
                                                                        class="form-control bed_number js-pc-bedding-changes">
                                                                        <option value="0" selected="">Select the number
                                                                            of beds</option>
                                                            ...
                                                            <div id="bed_line_SINGLE_2" class="bed_line">
                                                                <div class="form-group col-xs-6">
                                                                    <select
                                                                        class="form-control bed_type js-pc-bedding-changes"
                                                                        name="bedtype_id_SINGLE_2"
                                                                        id="bedtype_id_SINGLE_2">
                                                                ...
                                                                <div class="form-group col-xs-4">
                                                                    <select id="bed_number_SINGLE_2"
                                                                        name="bed_number_SINGLE_2"
                                                                        class="form-control bed_number js-pc-bedding-changes">
                                                                        <option value="0" selected="selected">Select the
                                                            ...
                                                            <div id="bed_line_SINGLE_3" class="bed_line">
                                                                <div class="form-group col-xs-6">
                                                                    <select
                                                                        class="form-control bed_type js-pc-bedding-changes"
                                                                        name="bedtype_id_SINGLE_3"
                                                                        id="bedtype_id_SINGLE_3">
                                                                        <option value="" selected="selected">Select a
                                                                            bed type</option>
                                                                        <option value="1" data-occupancy="1">
                                                                            Single bed
                                                                            &nbsp;&nbsp;/&nbsp;&nbsp;90-130 cm wide
                                                                        </option>
                                                                ...
                                                                <div class="form-group col-xs-4">
                                                                    <select id="bed_number_SINGLE_3"
                                                                        name="bed_number_SINGLE_3"
                                                                        class="form-control bed_number js-pc-bedding-changes">
                                                                        <option value="0" selected="selected">Select the
                                                                            number of beds</option>
                                        ...
                                        <fieldset class="bedding-options">
                                            <legend>
                                                Occupancy
                                            </legend>
                                            ...
                                            <div class="row" id="room_occupancy">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p>
                                                                Based on the bed information you have provided, we have
                                                                generated the following occupancy values – you can check
                                                                them and adjust them below. If you would like to set
                                                                rates for children, they can be added in the <a
                                                                    href="/hotel/hoteladmin/extranet_ng/manage/child_policies_pricing_occupancy.html?ses=528d27397d807510baedabb6ba9582bd&amp;lang=en&amp;hotel_id=7962700"
                                                                    target="_blank">section for children policies and
                                                                    rates</a>.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12 form-group" id="max_occupancy_form">
                                                            <h4>Total occupancy</h4>
                                                            <p>What is the total number of guests (adults and children)
                                                                that can stay here?</p>
                                                            <div class="col-lg-6">
                                                                <div class="row">
                                                                    <div class="bui-stepper"
                                                                        ...
                                                                        <div class="bui-stepper__wrapper">
                                                                            <input type="range" id="max_occupancy"
                                                                                name="max_occupancy"
                                                                                
                                                                                class="bui-stepper__input" min="0"
                                                                                max="50" value="1" 
                                                                             >
                                                                            <button 
                                                        ...
                                                        <div class="col-lg-12 form-group" id="max_adults_form">
                                                            <div class="bui-form__group "><label
                                                                    class="bui-checkbox"><input
                                                                        class="bui-checkbox__input " 
                                                                        type="checkbox" checked=""><span
                                                                        class="bui-checkbox__label" >Do
                                                                        you want to limit how many adults can stay
                                                                        here?</span></label></div>
                                                            <div class="col-lg-6 js-occupancy_stepper">
                                                                <div class="row">
                                                                    <div class="bui-stepper"
                                                                        >
                                                                        <div class="bui-stepper__title-wrapper">
                                                                            <label class="bui-stepper__title"
                                                                                for="num_guests">Maximum adults</label>
                                                                        </div>
                                                                        <div class="bui-stepper__wrapper">
                                                                            <input id="num_guests" name="num_guests"
                                                                                type="range"
                                                                                
                                                                                class="bui-stepper__input" min="0"
                                                                                value="1" aria-valuemin="0"
                                                                                aria-valuenow="1">
                                                                            <button 
                                                        ...
                                                        <div class="col-lg-12 form-group" id="max_children_form">
                                                            <div class="bui-form__group "><label
                                                                    class="bui-checkbox"><input
                                                                        class="bui-checkbox__input " 
                                                                        type="checkbox" checked=""><span
                                                                        class="bui-checkbox__label" >Do
                                                                        you want to limit how many children can stay
                                                                        here?</span></label></div>
                                                            <div class="col-lg-6 js-occupancy_stepper">
                                                                <div class="row">
                                                                    <div class="bui-stepper"
                                                                        ...
                                                                        <div class="bui-stepper__title-wrapper">
                                                                            <label class="bui-stepper__title"
                                                                                for="max_children_physical">Maximum
                                                                                children</label>
                                                                        </div>
                                                                        <div class="bui-stepper__wrapper">
                                                                            <input type="range" id="max_children"
                                                                                name="max_children_physical"
                                                                                
                                                                                class="bui-stepper__input" min="-1"
                                                                                value="0" 
                                                                                >
                                                                            <button 
                                        ...
                                        <div class="row no-return" id="room-cta">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 continue">
                                                <input type="submit" class="btn btn-primary btn-block btn-lg"
                                                    id="save_button" value="Continue">
                                            </div>
                                        </div>
                                    </form>
