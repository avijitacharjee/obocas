...
<head>
	...
	<link rel="stylesheet" href="assets/css/pages/facilities-services.min.css">
					...
					<div class="bui-container bui-container--center">
						...
						<div class="row">
							...
							<div class="col-md-8 main-content">
								<form id="surroundings_form" method="POST" role="form">
									...
									<fieldset>
										<div class="surrounding-group">
											...
											<div class="row surrounding-item ">
												...
												<div class="col-md-5">
													<label>Name</label>
													<input name="" value="" class="form-control surrounding-name">
												</div>
												...
												<div class="col-md-5">
													...
													<div class="input-group form-group">
														<div>
															<input type="text" class="form-control surrounding-distance"
																value="">
														</div>
														<div class="input-group-btn surrounding-unit-dropdown">
															<button type="button"
																class="btn btn-default dropdown-toggle unit-button"
																data-toggle="dropdown" aria-haspopup="true"
																aria-expanded="false">
																<span class="dropdown-title">Unit</span>
																<span class="caret"></span>
															</button>
															<ul class="dropdown-menu dropdown-menu-right">
																<li><a href="#" data-value="meters">metres</a></li>
																<li><a href="#" data-value="kilometers">kilometres</a>
																</li>
																<li><a href="#" data-value="feet">feet</a></li>
																<li><a href="#" data-value="miles">miles</a></li>
															</ul>
														</div><!-- /btn-group -->
												...
												<div class="col-md-5">
													...
													<div class="input-group form-group">
														...
														<div class="input-group-btn surrounding-unit-dropdown">
															...
															<input type="hidden" class="surrounding-distance-units"
																value="">
															<ul class="dropdown-menu dropdown-menu-right">
																<li><a href="#" data-value="meters">metres</a></li>
																<li><a href="#" data-value="kilometers">kilometres</a>
									...
									<fieldset>
										...
										<div class="surrounding-group">
											<h4 class="surrounding-group-header">Ski lift:</h4>
												...
												<div class="col-md-5">
													...
													<div class="input-group form-group">
														...
														<div class="input-group-btn surrounding-unit-dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-right">
																<li><a href="#">metres</a></li>
																<li><a href="#">kilometres</a>
																</li>
																<li><a href="#">feet</a></li>
										...
										<div class="ext-footer__ctas">
											...
											<div class="ext-feedback-cta ext-footer__cta">
												<button type="button" class="bui-button bui-button--primary">
													<span class="bui-button__text">
														<span possible-tags="ext_footer_feedback_share_feedback_cta">
															Share your feedback</span>
													</span>
												</button>
											</div>
										</div>
